...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;SPPMTC_PDF&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="RMP_SPPMTC_2017110310464400.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.3in" margin-right="0.3in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.3in" margin-right="0.3in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block>
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="solid" border-right-style="solid" border-style="none" border-top-style="solid" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									<fo:table-column column-width="2.100in"/>
									<fo:table-column column-width="3.800in"/>
									<fo:table-column column-width="2in"/>
									<xsl:variable name="altova:CurrContextGrid_1" select="."/>
									<xsl:variable name="altova:ColumnData"/>
									<fo:table-body start-indent="0pt">
										<fo:table-row border-bottom-style="solid" border-bottom-width="medium" border-color="gray">
											<fo:table-cell border-bottom-style="none" border-style="none" font-size="5pt" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="center">
													<xsl:for-each select="$XML">
														<xsl:for-each select="SPPMTC">
										...
										<fo:table-row font-family="Arial" font-size="15pt">
											<fo:table-cell border-style="none" font-size="6pt" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
											...
											<fo:table-cell border-style="none" font-size="6pt" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="center">
													<xsl:for-each select="$XML">
														<xsl:for-each select="SPPMTC">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="PRINTED-LABEL">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
							...
							<xsl:variable name="altova:table">
								<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row>
											<fo:table-cell font-size="5pt" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<fo:inline>
									...
									<fo:table-body start-indent="0pt">
										<xsl:for-each select="$XML">
											<xsl:for-each select="SPPMTC">
												<xsl:for-each select="SPECIAL-INFO">
																...
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			...
																			<fo:table-header start-indent="0pt">
																				<fo:table-row>
																					<fo:table-cell font-size="5pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<fo:inline>
																			...
																			<fo:table-body start-indent="0pt">
																				<xsl:for-each select="SPECIAL-PRICE-LINE">
																					<fo:table-row>
																						<fo:table-cell font-size="5pt" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="left">
																								<xsl:for-each select="BRANCH-ID">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																						...
																						<fo:table-cell font-size="5pt" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="left">
																								<xsl:for-each select="USE-CAT-COST">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
