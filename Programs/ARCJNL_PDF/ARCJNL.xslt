...
<!--Designed and generated by Altova StyleVision Enterprise Edition 2018 (x64) - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;ARCJNL&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_ARCJNL.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.05in" margin-right="0.05in" page-height="11in" page-width="8.50in" margin-top="0.0in" margin-bottom="0.05in">
				<fo:region-body margin-top="0.05in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.05in" margin-right="0.05in" page-height="11in" page-width="8.50in" margin-top="0.0in" margin-bottom="0.05in">
				<fo:region-body margin-top="0.05in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:xmp="http://ns.adobe.com/xap/1.0/">
								<xmp:CreatorTool>Altova StyleVision Enterprise Edition 2018 (x64) (http://www.altova.com)</xmp:CreatorTool>
							</rdf:Description>
						</rdf:RDF>
					</x:xmpmeta>
				</fo:declarations>
						...
						<fo:block white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									<fo:table-column column-width="8.400in"/>
									<xsl:variable name="altova:CurrContextGrid_1" select="."/>
									<xsl:variable name="altova:ColumnData"/>
									<fo:table-body start-indent="0pt">
										<xsl:for-each select="$XML">
											<xsl:for-each select="ARCJNL">
												<xsl:for-each select="BRANCH-LEVEL">
													<fo:table-row height="0.01in">
														<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
															<fo:block text-align="left">
																<altova:line-break/>
																<xsl:variable name="altova:table">
																	<fo:table border-left-style="none" border-right-style="none" border-top-style="none" font-size="xx-small" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-cols="empty">
																		...
																		<fo:table-column column-width="0.540in"/>
																		<xsl:variable name="altova:CurrContextGrid_2" select="."/>
																		<xsl:variable name="altova:ColumnData"/>
																		<fo:table-header start-indent="0pt">
																			<fo:table-row>
																				<fo:table-cell number-columns-spanned="11" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left">
																						<xsl:variable name="altova:table">
																							<fo:table font-size="small" width="100%" table-layout="fixed" border-spacing="2pt">
																								...
																								<fo:table-body start-indent="0pt">
																									<fo:table-row height="0.24in">
																										<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="large" font-weight="bold" padding="0" display-align="center">
																										...
																										<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="0" display-align="center">
																									...
																									<fo:table-row>
																										<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="0" display-align="center">
																											<fo:block text-align="left">
																												<xsl:variable name="altova:table">
																													<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																														<fo:table-column column-width="0.660in"/>
																														<fo:table-column column-width="4.400in"/>
																														<fo:table-column column-width="1.100in"/>
																														<fo:table-column column-width="2.210in"/>
																														...
																														<fo:table-body start-indent="0pt">
																															...
																															<fo:table-row>
																																...
																																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																																	<fo:block text-align="left">
																																		<xsl:for-each select="HEADER">
																																			<xsl:for-each select="REG-DATE-LABEL">
																																				<altova:inline-container-substitute>
																																					<xsl:apply-templates/>
																																				</altova:inline-container-substitute>
																																			</xsl:for-each>
																			...
																			<fo:table-row>
																				<fo:table-cell border-left-style="none" border-right-style="none" border-top-style="none" font-size="x-small" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left">
																						<xsl:for-each select="HEADER">
																							<xsl:for-each select="BRANCH-LABEL">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																		...
																		<fo:table-body start-indent="0pt">
																			<xsl:for-each select="DETAIL">
																				<xsl:for-each select="DETAIL-DATA">
																					<fo:table-row>
																...
																<altova:line-break/>
																<xsl:variable name="altova:table">
																	<fo:table font-size="smaller" keep-together.within-page="always" keep-together.within-column="always" keep-with-previous.within-page="auto" keep-with-previous.within-column="auto" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																		<fo:table-column column-width="4.220in"/>
																		...
																		<fo:table-body start-indent="0pt">
																			<fo:table-row>
																				<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																					<fo:block text-align="left">
																						<xsl:variable name="altova:table">
																							<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																								<fo:table-column column-width="4.180in"/>
																								<xsl:variable name="altova:CurrContextGrid_6" select="."/>
																								<xsl:variable name="altova:ColumnData"/>
																								<fo:table-body start-indent="0pt">
																									<xsl:for-each select="TOTALS">
																										<xsl:for-each select="TOTALS-BLOCK">
																											<fo:table-row>
																												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																														<xsl:variable name="altova:table">
																															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																																...
																																<fo:table-body start-indent="0pt">
																																	<xsl:for-each select="TOTALS-DATA">
																																		...
																																		<fo:table-row>
																																			<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-style="italic" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																				<fo:block text-align="left">
																																					<xsl:for-each select="SUB-DESC">
																																						<altova:inline-container-substitute>
																																							<xsl:apply-templates/>
																																						</altova:inline-container-substitute>
																																					</xsl:for-each>
																											...
																											<fo:table-row>
																												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="xx-small" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																														<fo:inline>
																															<xsl:text>&#160;</xsl:text>
																														</fo:inline>
