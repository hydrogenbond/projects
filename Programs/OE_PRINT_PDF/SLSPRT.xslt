...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;SLSPRT&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGFILE_SLSPRT.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.25in" margin-right="0.20in" page-height="11in" page-width="8.50in" margin-top="0.20in" margin-bottom="0.1in">
				<fo:region-body margin-top="4.40in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="4.40in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.25in" margin-right="0.20in" page-height="11in" page-width="8.50in" margin-top="0.20in" margin-bottom="0.1in">
				<fo:region-body margin-top="4.40in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="4.40in"/>
			</fo:simple-page-master>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:dc="http://purl.org/dc/elements/1.1/">
								<dc:title>AGREEMENT/RECEIPT</dc:title>
								<dc:creator>LJEWELL_20160505</dc:creator>
								<dc:description>OE_PRINT_PDF</dc:description>
							</rdf:Description>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
						...
						<fo:block-container overflow="hidden" display-align="before">
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table margin-left="0" margin-top="0" padding-left="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="7.900in"/>
										<xsl:variable name="altova:CurrContextGrid_1" select="."/>
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row height="0.23in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
													...
													<fo:block text-align="right">
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																...
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-body start-indent="0pt">
																	<fo:table-row height="1.60in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="{SLSPRT/HEADER-INFO/LOGO-INFO/LOGO-POS}">
																				<xsl:if test="exists( SLSPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC )">
																					<xsl:variable name="altova:sUrlOrData" select="SLSPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC"/>
																					...
																					<fo:external-graphic margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" scaling="non-uniform">
																						<xsl:variable name="sText-align">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="SLSPRT/HEADER-INFO/LOGO-INFO/LOGO-POS"/>
																							</xsl:call-template>
																						</xsl:variable>
																						...
																						<xsl:variable name="sContent-height">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="SLSPRT/HEADER-INFO/LOGO-INFO/LOGO-HEIGHT"/>
																							</xsl:call-template>
																						</xsl:variable>
																						...
																						<xsl:attribute name="src">
																							...
																							<xsl:call-template name="altova:double-backslash">
																								<xsl:with-param name="text">
																									<xsl:value-of select="string(SLSPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC)"/>
																								</xsl:with-param>
																								<xsl:with-param name="text-length">
																									<xsl:value-of select="string-length(string(SLSPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC))"/>
																								</xsl:with-param>
																							</xsl:call-template>
																							<xsl:text>)</xsl:text>
																						</xsl:attribute>
																				...
																				<xsl:if test="exists( SLSPRT/HEADER-INFO/TEXT-HEADER )">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
												...
												<fo:table-cell font-size="10pt" padding="0" display-align="before">
													<fo:block text-align="right">
														<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
															<xsl:variable name="altova:table">
																<fo:table border-top-style="none" font-size="9pt" line-height=".8" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																	<fo:table-column column-width="0.250in"/>
																	<fo:table-column column-width="3.650in"/>
																	<fo:table-column column-width="3.980in"/>
																	<xsl:variable name="altova:CurrContextGrid_4" select="."/>
																	<xsl:variable name="altova:ColumnData"/>
																	<fo:table-body border-bottom-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																		<fo:table-row height=".12in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-bottom-width="thin" border-left-color="gray" border-left-style="solid" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="solid" border-top-width="thin" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																			<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-bottom-width="thin" border-left-color="gray" border-left-style="none" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="solid" border-top-width="thin" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left">
																					<altova:line-break/>
																				</fo:block>
																			</fo:table-cell>
																			<fo:table-cell number-rows-spanned="6" border-bottom-color="gray" border-bottom-width="thin" border-left-style="none" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="solid" border-top-width="thin" font-size="x-large" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="right">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".10in" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" altova:hide-rows="empty">
																							<fo:table-column column-width="1.310in"/>
																							<fo:table-column column-width="2.650in"/>
																							<xsl:variable name="altova:CurrContextGrid_5" select="."/>
																							<xsl:variable name="altova:ColumnData"/>
																							<fo:table-body start-indent="0pt">
																								<fo:table-row border-right-style="none" line-height=".18in" margin-bottom="0" margin-top="0">
																									<fo:table-cell border-left-style="solid" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="after" altova:is-body-cell="true">
																										<fo:block text-align="right">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																													<xsl:for-each select="HEADER-INFO">
																									...
																									<fo:table-cell border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="after" altova:is-body-cell="true">
																										<fo:block text-align="left">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																													<xsl:for-each select="HEADER-INFO">
																								...
																								<fo:table-row border-right-style="none" line-height=".08in" margin-bottom="0" margin-top="0" padding-top="0">
																									<fo:table-cell background-color="#f0f0f0" border-left-style="solid" border-top-style="none" font-size="9pt" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="right">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																													<xsl:for-each select="HEADER-INFO">
																														<xsl:for-each select="BLOCK2">
																															<xsl:for-each select="TDATE-T">
																																<altova:inline-container-substitute>
																																	<xsl:apply-templates/>
																																</altova:inline-container-substitute>
																															</xsl:for-each>
																									...
																									<fo:table-cell border-right-style="none" border-top-style="none" font-size="9pt" font-weight="normal" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="left">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																													<xsl:for-each select="HEADER-INFO">
																														<xsl:for-each select="BLOCK2">
																															<xsl:for-each select="TDATE">
																																<altova:inline-container-substitute>
																																	<xsl:apply-templates/>
																																</altova:inline-container-substitute>
																															</xsl:for-each>
																								...
																								<xsl:choose>
																									<xsl:when test="exists( SLSPRT/HEADER-INFO/BLOCK2/SHIPVIA )">
																										<fo:table-row border-right-style="none" line-height=".08in" margin-bottom="0" margin-top="0" padding-top="0">
																											<fo:table-cell background-color="#f0f0f0" border-left-style="solid" border-top-style="none" font-size="9pt" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																												<fo:block text-align="right">
																													<xsl:for-each select="$XML">
																								...
																								<fo:table-row border-right-style="none" line-height=".08in" margin-bottom="0" margin-top="0" padding-top="0">
																									<fo:table-cell background-color="#f0f0f0" border-bottom-style="none" border-left-style="solid" border-top-style="none" font-size="9pt" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="right">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																													<xsl:for-each select="HEADER-INFO">
																									...
																									<fo:table-cell border-bottom-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="normal" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="left">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																													<xsl:for-each select="HEADER-INFO">
																		...
																		<fo:table-row border-bottom-style="none" height=".09in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-bottom-width="thin" border-left-color="gray" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="none" border-top-width="thin" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																			<fo:table-cell number-rows-spanned="5" border-bottom-color="gray" border-bottom-width="thin" border-left-color="gray" border-left-style="none" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="none" border-top-width="thin" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="before">
																				<fo:block text-align="left">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" altova:hide-rows="empty">
																							<fo:table-column column-width="proportional-column-width(1)"/>
																							<xsl:variable name="altova:CurrContextGrid_6" select="."/>
																							<xsl:variable name="altova:ColumnData"/>
																							<fo:table-body start-indent="0pt">
																								<fo:table-row height=".09in" line-height=".09in" padding-bottom="0" padding-top="0">
																									<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="left">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																													<xsl:for-each select="HEADER-INFO">
																		...
																		<fo:table-row height=".09in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-bottom-width="thin" border-left-color="gray" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="none" border-top-width="thin" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																		</fo:table-row>
																		<fo:table-row height=".09in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-bottom-width="thin" border-left-color="gray" border-left-style="none" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="none" border-top-width="thin" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																		</fo:table-row>
																		<fo:table-row height=".09in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-color="gray" border-bottom-width="thin" border-left-color="gray" border-left-width="thin" border-right-color="gray" border-right-style="none" border-right-width="thin" border-top-color="gray" border-top-style="none" border-top-width="thin" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																		</fo:table-row>
																	</fo:table-body>
														...
														<altova:line-break/>
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" line-height=".8" margin-bottom="0" padding-bottom="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="0.010in"/>
																<fo:table-column column-width="2.850in"/>
																<fo:table-column column-width="1.450in"/>
																<fo:table-column column-width="0.080in"/>
																<fo:table-column column-width="2.350in"/>
																<fo:table-column column-width="1.140in"/>
																<xsl:variable name="altova:CurrContextGrid_7" select="."/>
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-header start-indent="0pt">
																	<fo:table-row line-height=".11in" padding-bottom="0" padding-top="0">
																		<fo:table-cell number-columns-spanned="3" background-color="#f0f0f0" font-weight="bold" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left"/>
																		</fo:table-cell>
																		<fo:table-cell number-columns-spanned="2" background-color="#f0f0f0" font-weight="bold" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="center">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
																...
																<fo:table-body margin-bottom="0" start-indent="0pt">
																	<fo:table-row line-height=".11in" padding-bottom="0" padding-top="0">
																		<fo:table-cell number-rows-spanned="5" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-color="gray" border-left-style="solid" border-right-style="none" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left"/>
																		</fo:table-cell>
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
																							<xsl:for-each select="BOX1">
																								<xsl:for-each select="BOX1-DATA">
																									<xsl:for-each select="BOX-SPECIAL-Q">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="thin" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
																		...
																		<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="thin" border-right-color="gray" border-right-style="solid" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
																	...
																	<fo:table-row line-height=".11in" padding-bottom="0" padding-top="0">
																		<fo:table-cell number-columns-spanned="2" number-rows-spanned="4" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="thin" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:variable name="altova:table">
																					<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="0" padding-left="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																						<fo:table-column column-width="proportional-column-width(1)"/>
																											...
																											<xsl:for-each select="BOX1-DATA">
																												<xsl:for-each select="BOX-SPECIAL">
																													<xsl:for-each select="BOX-SPECIAL-COMMENT">
																														<fo:table-row line-height=".11in" padding-bottom="0" padding-top="0">
																															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-top="0" padding-bottom="0" padding-left="0" border="solid 1pt gray" padding="2pt" display-align="center">
																																<fo:block text-align="left">
																																	<altova:inline-container-substitute>
																																		<xsl:apply-templates/>
																																	</altova:inline-container-substitute>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="thin" border-right-style="none" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
																	...
																	<fo:table-row line-height=".11in" padding-bottom="0" padding-top="0">
																		...
																		<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-color="gray" border-left-style="solid" border-left-width="thin" border-right-style="none" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
																		...
																		<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-style="none" border-right-color="gray" border-right-style="solid" border-top-style="none" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="SLSPRT">
																						<xsl:for-each select="HEADER-INFO">
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-next.within-page="always" keep-with-next.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" margin-bottom="0" margin-left="0" margin-top="0" padding-bottom="0" padding-left="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									<fo:table-column column-width="11.930in"/>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:variable name="altova:table">
														<fo:table border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-color="gray" border-top-style="solid" font-size="9pt" line-height=".8" margin-left="0" margin-top="0" padding-left="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
															<fo:table-column column-width="0.150in"/>
															<fo:table-column column-width="0.400in"/>
															<fo:table-column column-width="2.670in"/>
															<fo:table-column column-width="0.840in"/>
															...
															<xsl:variable name="altova:ColumnData"/>
															<fo:table-header start-indent="0pt">
																<fo:table-row background-color="#f0f0f0" border-bottom-color="gray" border-bottom-style="solid" border-top-color="gray" border-top-style="solid" height="0.10in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																	<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="none" border-top-style="none" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block text-align="left"/>
																	</fo:table-cell>
																	<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<xsl:for-each select="$XML">
																				<xsl:for-each select="SLSPRT">
																	...
																	<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="solid" border-top-style="none" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block text-align="right">
																			<xsl:for-each select="$XML">
																				<xsl:for-each select="SLSPRT">
																					<xsl:for-each select="MATERIAL-HEADER">
																	...
																	<xsl:for-each select="SLSPRT">
																		<xsl:for-each select="MATERIAL">
																			<xsl:for-each select="BUNDLE">
																				<fo:table-row border-bottom-color="gray" border-top-color="gray" border-top-style="solid" height="0.16in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																					<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																						<fo:block text-align="left"/>
																					</fo:table-cell>
																					<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" text-decoration="underline" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																						<fo:block text-align="left">
																					...
																					<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="black" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																						<fo:block text-align="right">
																				...
																				<fo:table-row border-bottom-color="gray" border-bottom-style="none" border-top-color="gray" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																					<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																						<fo:block text-align="left"/>
																					</fo:table-cell>
																					<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																						<fo:block text-align="left">
																							<xsl:variable name="altova:table">
																								<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".7" margin-bottom="0" margin-left="0" margin-top="0.03in" padding-bottom="0" padding-left="0" padding-top="0.03in" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																									...
																									<fo:table-column column-width="1.490in"/>
																									<fo:table-column column-width="0.730in"/>
																									<fo:table-column column-width="1.530in"/>
																									<xsl:variable name="altova:CurrContextGrid_11" select="."/>
																									<xsl:variable name="altova:ColumnData"/>
																									<fo:table-body start-indent="0pt">
																										<xsl:for-each select="BUNDLE-LINES">
																											<fo:table-row border-bottom-color="gray" border-top-color="gray" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																												<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left"/>
																												</fo:table-cell>
																												<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																												...
																												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																														<xsl:for-each select="LINE-AST-COMMENT">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
																											...
																											<fo:table-row border-bottom-color="gray" border-top-color="gray" keep-with-next.within-page="always" keep-with-next.within-column="always" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																												<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																												...
																												<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																											...
																											<fo:table-row border-bottom-color="gray" border-top-color="gray" keep-with-previous.within-page="always" keep-with-previous.within-column="always" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																												<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left"/>
																												</fo:table-cell>
																												<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																												...
																												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																											...
																											<fo:table-row border-bottom-color="gray" border-top-color="gray" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																												...
																												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																											...
																											<fo:table-row border-bottom-color="gray" border-top-color="gray" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																												...
																												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																														<xsl:if test="exists( LINE-INV-DETAIL/LINE-DETAIL/LINE-INV-DETAIL-ROLL )">
																															<xsl:variable name="altova:table">
																																		...
																																		<xsl:for-each select="LINE-INV-DETAIL">
																																			<xsl:for-each select="LINE-DETAIL">
																																				<fo:table-row>
																																					...
																																					<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																																						<fo:block text-align="left">
																																							<xsl:for-each select="LINE-INV-DETAIL-TYPECODE">
																																								<altova:inline-container-substitute>
																																									<xsl:apply-templates/>
																																								</altova:inline-container-substitute>
																																							</xsl:for-each>
																																							...
																																							<xsl:for-each select="LINE-INV-DETAIL-TYPERET">
																																								<altova:inline-container-substitute>
																																									<xsl:apply-templates/>
																																								</altova:inline-container-substitute>
																																							</xsl:for-each>
																											...
																											<fo:table-row border-bottom-color="gray" border-top-color="gray" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																												...
																												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																														<xsl:variable name="altova:table">
																															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".7" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																																<fo:table-column column-width="proportional-column-width(1)"/>
																																...
																																<fo:table-body start-indent="0pt">
																																	<xsl:for-each select="LINE-COMMENTS">
																																		<xsl:for-each select="LINE-COMMENT">
																																			<fo:table-row border-bottom-color="gray" border-top-color="gray" line-height=".7">
																																				<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																					<fo:block text-align="left">
																																						<altova:inline-container-substitute>
																																							<xsl:apply-templates/>
																				...
																				<xsl:choose>
																					<xsl:when test="exists( BUNDLE-TOTAL )">
																						<fo:table-row border-bottom-color="gray" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																							<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																								<fo:block text-align="left"/>
																							</fo:table-cell>
																							<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																								<fo:block text-align="right">
										...
										<fo:table-row>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:if test="exists( SLSPRT/ORDER-COMMENTS/ORDER-COMMENT )">
														<altova:line-break/>
														<xsl:variable name="altova:table">
															<fo:table border-bottom-color="gray" border-left-color="gray" border-right-color="gray" border-top-color="gray" keep-together.within-page="always" keep-together.within-column="always" line-height=".7" margin-bottom="0" margin-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="7.920in"/>
																<xsl:variable name="altova:CurrContextGrid_14" select="."/>
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-body start-indent="0pt">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="SLSPRT">
																			<xsl:for-each select="ORDER-COMMENTS">
																				<xsl:for-each select="ORDER-COMMENT">
																					<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																						<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="left">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
													...
													<altova:line-break/>
													<xsl:if test="exists( SLSPRT/CARE )">
														<xsl:variable name="altova:table">
															<fo:table border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="4.020in"/>
																<fo:table-column column-width="0.010in"/>
																<fo:table-column column-width="proportional-column-width(1)"/>
																...
																<fo:table-body start-indent="0pt">
																	<fo:table-row>
																		<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:if test="exists( SLSPRT/CC-DEPOSITS/DEPOSIT/CARD-TYPE )">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-color="gray" border-top-style="solid" font-family="8pt" keep-together.within-page="always" keep-together.within-column="always" line-height=".6" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																							<fo:table-column column-width="0.800in"/>
																							<fo:table-column column-width="0.800in"/>
																							...
																							<fo:table-header start-indent="0pt">
																								<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																									<fo:table-cell number-columns-spanned="4" background-color="#f0f0f0" border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" font-weight="bold" margin-bottom="0" margin-left="0" margin-right="0" padding-bottom="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block text-align="center">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="SLSPRT">
																									...
																									<xsl:for-each select="SLSPRT">
																										<xsl:for-each select="CC-DEPOSITS">
																											<xsl:for-each select="DEPOSIT">
																												<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																													<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" padding-bottom="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																														<fo:block text-align="left">
																															<fo:inline>
																																<xsl:text>&#160; </xsl:text>
																															</fo:inline>
																												...
																												<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																													<fo:table-cell number-columns-spanned="4" border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" margin-left="0" margin-right="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																														<fo:block text-align="left">
																															<xsl:if test="exists(ADJUSTMENT/ADJ-CARD-APPROVAL )">
																																<xsl:variable name="altova:table">
																																	<fo:table border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" line-height=".9" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																																		<fo:table-column column-width="0.800in"/>
																																		<fo:table-column column-width="0.820in"/>
																																		<fo:table-column column-width="0.860in"/>
																																		...
																																		<fo:table-body start-indent="0pt">
																																			<xsl:for-each select="ADJUSTMENT">
																																				<fo:table-row>
																																					<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																																						<fo:block text-align="left">
																																							<fo:inline>
																																								<xsl:text>&#160; </xsl:text>
																																							</fo:inline>
																		...
																		<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left"/>
																		</fo:table-cell>
																		<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:variable name="altova:table">
																					<fo:table border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-color="gray" border-top-style="solid" font-size="9pt" line-height="1.0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																						<fo:table-column column-width="2.600in"/>
																								...
																								<xsl:for-each select="SLSPRT">
																									<xsl:for-each select="MATERIAL-TOTALS">
																										<xsl:for-each select="TOTAL">
																											<fo:table-row>
																												<fo:table-cell background-color="#f0f0f0" border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="solid" border-top-color="gray" border-top-style="none" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																													<fo:block text-align="right">
																												...
																												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																													<fo:block text-align="right">
													...
													<xsl:if test="exists( SLSPRT/NOCARE )">
														<xsl:variable name="altova:table">
															<fo:table border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" font-size="9pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="4.020in"/>
																<fo:table-column column-width="1.350in"/>
																<fo:table-column column-width="proportional-column-width(1)"/>
																	...
																	<fo:table-row>
																		<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-color="gray" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:if test="exists( SLSPRT/CC-DEPOSITS/DEPOSIT/CARD-TYPE )">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-color="gray" border-top-style="solid" font-family="8pt" line-height=".6" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																							<fo:table-column column-width="0.800in"/>
																							<fo:table-column column-width="0.800in"/>
																							<fo:table-column column-width="0.850in"/>
																							<fo:table-column column-width="1.490in"/>
													...
													<xsl:if test="exists(SLSPRT/TAX-ID/CUST-TAX-ID )">
														<altova:line-break/>
														<xsl:for-each select="$XML">
															<xsl:for-each select="SLSPRT">
													...
													<xsl:if test="exists( SLSPRT/PAGE-FOOTER/PAGEFOOTER )">
														<altova:line-break/>
														<altova:line-break/>
														<xsl:variable name="altova:table">
													...
													<altova:line-break/>
													<xsl:if test="exists( SLSPRT/SIGNATURE )">
														<altova:line-break/>
														<fo:inline>
															<xsl:text>&#160;</xsl:text>
														</fo:inline>
													...
													<altova:line-break/>
													<xsl:if test="exists( SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC )">
														<xsl:variable name="altova:table">
															<fo:table keep-with-previous.within-page="always" keep-with-previous.within-column="always" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" width="100%" table-layout="fixed" border-spacing="2pt">
																<fo:table-column column-width="8in"/>
																<xsl:variable name="altova:CurrContextGrid_24" select="."/>
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-body start-indent="0pt">
																	<fo:table-row height="1.50in" keep-with-previous.within-page="always" keep-with-previous.within-column="always" padding-bottom="0" padding-top="0" table-omit-footer-at-break="true">
																		<fo:table-cell font-size="10pt" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" display-align="before">
																			<fo:block text-align="{SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-POS}">
																				<xsl:if test="exists( SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC )">
																					<xsl:variable name="altova:sUrlOrData" select="SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC"/>
																					<xsl:variable name="altova:seqWidthHeight" as="xs:integer*">
																						<xsl:choose use-when="function-available('altovaext:get-width-and-height-from-image-data')">
																							<xsl:when test="unparsed-text-available($altova:sUrlOrData, 'x-binarytobase64')">
																								<xsl:sequence select="altovaext:get-width-and-height-from-image-data(xs:base64Binary(unparsed-text($altova:sUrlOrData, 'x-binarytobase64')))"/>
																					...
																					<fo:external-graphic margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="00" padding-top="0" scaling="non-uniform">
																						<xsl:variable name="sText-align">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-POS"/>
																							</xsl:call-template>
																						</xsl:variable>
																						<xsl:if test="$sText-align != ''">
																							<xsl:attribute name="text-align">
																						...
																						<xsl:variable name="sContent-height">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-HEIGHT"/>
																							</xsl:call-template>
																						</xsl:variable>
																						<xsl:if test="$sContent-height != ''">
																							<xsl:attribute name="content-height">
																						...
																						<xsl:attribute name="src">
																							...
																							<xsl:call-template name="altova:double-backslash">
																								<xsl:with-param name="text">
																									<xsl:value-of select="string(SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC)"/>
																								</xsl:with-param>
																								<xsl:with-param name="text-length">
																									<xsl:value-of select="string-length(string(SLSPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC))"/>
																								</xsl:with-param>
																							</xsl:call-template>
																							<xsl:text>)</xsl:text>
																						</xsl:attribute>
