...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;CONTACTS&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="CONTACTS.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.5in" margin-right="0.5in" page-height="8.50in" page-width="11in" margin-top="0.25in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.05in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="1.05in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.5in" margin-right="0.5in" page-height="8.50in" page-width="11in" margin-top="0.25in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.05in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="1.05in"/>
			</fo:simple-page-master>
			...
			<fo:root>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
						...
						<fo:block-container overflow="hidden" display-align="before">
							<fo:block font-size="9px">
								<xsl:variable name="altova:table">
									<fo:table font-size="8pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="1.990in"/>
										<fo:table-column column-width="6.750in"/>
										<fo:table-column column-width="0.560in"/>
										<fo:table-column column-width="0.670in"/>
										<xsl:variable name="altova:CurrContextGrid_1" select="."/>
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" margin-bottom="0" margin-top="0" padding="0" padding-bottom="0" padding-top="0" display-align="center">
													<fo:block text-align="left">
													...
													<fo:block text-align="left">
															...
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-DATE-T">
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-DATE-BEG">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-THRU-T">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-DATE-END">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-CUST-T">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-CUST">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-USER-T">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-USERS">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-DATE">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-SALES-T">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-SALES">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
																...
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="TITLE">
																			<altova:inline-container-substitute font-size="12pt" font-weight="bold">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
																	</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-TIME">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-SORT-T">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-SORT">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="CONTACTS">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="HEADER">
																		<xsl:for-each select="PRINTED-USER">
																			<altova:inline-container-substitute font-size="9pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block font-size="9px" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row empty-cells="hide" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
									...
									<fo:table-body start-indent="0pt">
										<xsl:for-each select="$XML">
											<xsl:for-each select="CONTACTS">
												<xsl:for-each select="CONTACTS-DATA">
													<xsl:for-each select="CONTACT-SORT">
														<fo:table-row empty-cells="hide" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															<fo:table-cell background-color="#e1e1e1" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="right">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="CONTACTS">
																			<xsl:for-each select="HEADER-INFO">
															...
															<fo:table-cell background-color="#e1e1e1" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																	...
																	<xsl:for-each select="SORT-COLUMN">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
														...
														<xsl:choose>
															<xsl:when test="contains( /CONTACTS/HEADER-INFO/HEADER/PRINTED-SORT ,  &quot;Customer ID&quot; )">
																<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																	<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
																		<fo:block text-align="center">
																			<xsl:variable name="altova:table">
																				<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="0.21in" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																					<fo:table-column column-width="0.650in"/>
																					<fo:table-column column-width="0.700in"/>
																					<fo:table-column column-width="0.700in"/>
																					<fo:table-column column-width="0.690in"/>
																					<fo:table-column column-width="6.790in"/>
																					<xsl:variable name="altova:CurrContextGrid_3" select="."/>
																					<xsl:variable name="altova:ColumnData"/>
																					<fo:table-header start-indent="0pt">
																						<fo:table-row empty-cells="hide">
																							<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="600" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="center">
																					...
																					<fo:table-body start-indent="0pt">
																						<xsl:for-each select="CONTACT">
																							<xsl:for-each select="CONTACT-NOTES">
																								<xsl:for-each select="NOTE">
																									<xsl:sort select="EDIT-DATE" data-type="text" order="descending"/>
																									<xsl:sort select="EDIT-TIME" data-type="text" order="descending"/>
																									<fo:table-row>
																										<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																											<fo:block text-align="center">
																												<xsl:for-each select="EDIT-USER">
																													<altova:inline-container-substitute>
																														<xsl:apply-templates/>
																													</altova:inline-container-substitute>
																												</xsl:for-each>
																									...
																									<fo:table-row>
																										<fo:table-cell background-color="#f0f0f0" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																											<fo:block text-align="right"/>
																										</fo:table-cell>
																										<fo:table-cell number-columns-spanned="4" background-color="#f0f0f0" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																											<fo:block text-align="left">
																												<xsl:for-each select="NOTE">
																													<altova:inline-container-substitute>
																														<xsl:apply-templates/>
														...
														<xsl:choose>
															<xsl:when test="contains( /CONTACTS/HEADER-INFO/HEADER/PRINTED-SORT ,  &quot;User ID&quot; )">
																<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																		...
																		<fo:block text-align="left">
																			<xsl:variable name="altova:table">
																				<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="0.21in" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																					...
																					<fo:table-column column-width="2.330in"/>
																					<fo:table-column column-width="0.700in"/>
																					<fo:table-column column-width="0.700in"/>
																					<fo:table-column column-width="0.730in"/>
																					<fo:table-column column-width="4.150in"/>
																							...
																							<xsl:for-each select="CONTACT-NOTES">
																								<xsl:for-each select="NOTE">
																									...
																									<fo:table-row>
																										<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																											<fo:block text-align="center">
																												<xsl:for-each select="NOTE-CUSTID">
																													<altova:inline-container-substitute>
																														<xsl:apply-templates/>
																													</altova:inline-container-substitute>
																												</xsl:for-each>
																									...
																									<fo:table-row>
																										...
																										<fo:table-cell number-columns-spanned="5" background-color="#f0f0f0" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																											<fo:block text-align="left">
																												<xsl:for-each select="NOTE">
																													<altova:inline-container-substitute>
																														<xsl:apply-templates/>
														...
														<xsl:choose>
															<xsl:when test="contains( /CONTACTS/HEADER-INFO/HEADER/PRINTED-SORT ,  &quot;Sales Rep&quot; )">
																<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																	<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<xsl:variable name="altova:table">
