...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;CITYACCUM2&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_CITYACCUM2.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.3in" margin-right="0.3in" page-height="8.50in" page-width="11in" margin-top="0.10in" margin-bottom="0.0in">
			...
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.3in" margin-right="0.3in" page-height="8.50in" page-width="11in" margin-top="0.10in" margin-bottom="0.0in">
				<fo:region-body margin-top="0.30in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
							...
							<fo:block font-size="8pt">
								<xsl:variable name="altova:table">
									<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="10.340in"/>
												...
												<fo:table-cell font-size="10pt" font-weight="bold" padding="0" display-align="center">
													<fo:block text-align="center">
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="CITYACCUM2">
														...
														<xsl:if test="exists( CITYACCUM2/HEADER-INFO/ENDDATE )">
															<fo:inline>
					...
					<fo:static-content flow-name="odd-page-footer">
						<fo:block-container height="0.30in" overflow="hidden" display-align="after">
							<fo:block font-size="8pt">
								<xsl:variable name="altova:table">
									<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="8.580in"/>
							...
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray">
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row>
											<fo:table-cell border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
																		...
																		<fo:table-body start-indent="0pt">
																			<fo:table-row>
																				...
																				<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																					...
																					<fo:table-cell number-columns-spanned="2" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="8pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left">
																						<fo:inline>
																				...
																				<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																					<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																					<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																					<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="8pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="center">
																							<fo:inline>
																								<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160; Q</xsl:text>
																							</fo:inline>
																				...
																				<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="8pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="center">
																						<fo:inline>
												...
												<xsl:for-each select="CITYINFO">
													<xsl:for-each select="CITY">
														<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-style="none" border-right-width="thick" border-top-style="none" border-top-width="thick" font-size="8pt" margin-bottom="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																			...
																			<fo:table-body margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																				<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																					...
																					<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																						<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																						<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																						<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-style="none" border-right-width="thick" border-top-style="none" border-top-width="thick" font-size="8pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="right">
																						...
																						<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-style="none" border-top-width="thick" font-size="8pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="center">
															...
															<fo:block text-align="left">
																<xsl:variable name="altova:table">
																	<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																		...
																		<fo:table-body start-indent="0pt">
																			<fo:table-row>
																				<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left">
																						<fo:inline>
																				...
																				<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																					<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																					<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																					<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
																						<xsl:variable name="sBackground-color">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="if(ACCUMTODISPLAY= &quot;C&quot;) then &quot;orange&quot; else &quot;#bcb397&quot;"/>
																							</xsl:call-template>
																					...
																					<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-style="none" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
																						<xsl:variable name="sBackground-color">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="if(ACCUMTODISPLAY= &quot;C&quot;) then &quot;orange&quot; else &quot;#bcb397&quot;"/>
																							</xsl:call-template>
