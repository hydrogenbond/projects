...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;ARLABL2&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_ARLABL2.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.15in" margin-right="0.20in" page-height="11in" page-width="8.50in" margin-top="0.0in" margin-bottom="0.0in">
				<fo:region-body margin-top="0.46in" margin-bottom="0.10in" column-count="1" column-gap="0.30in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.15in" margin-right="0.20in" page-height="11in" page-width="8.50in" margin-top="0.0in" margin-bottom="0.0in">
				<fo:region-body margin-top="0.46in" margin-bottom="0.10in" column-count="1" column-gap="0.30in"/>
			</fo:simple-page-master>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block font-size="10pt">
							<xsl:if test="position() &gt; 9 and position() mod 10 = 0">
								<altova:page-break/>
							</xsl:if>
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" max-width="2.525in" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									<fo:table-column column-width="2.710in"/>
									<fo:table-column column-width="2.710in"/>
									<fo:table-column column-width="2.710in"/>
									...
									<fo:table-body start-indent="0pt">
										<xsl:for-each select="$XML">
											<xsl:for-each select="ARLABL2">
												<xsl:for-each select="LABELS">
													<xsl:for-each select="LABELS-ROW">
														<fo:table-row height=".941in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left=".15in" margin-right=".3in" margin-top="0" max-width="2.60in" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			...
																			<fo:table-body margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																				<xsl:for-each select="LABEL1">
																					<fo:table-row line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																						<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="left">
																								<xsl:for-each select="NAME">
																									<altova:inline-container-substitute padding-bottom="0">
																										<xsl:apply-templates/>
																					...
																					<xsl:choose>
																						<xsl:when test="exists( PHONE ) or exists( ID )">
																							<fo:table-row line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																									<fo:block text-align="left">
																					...
																					<fo:table-row line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																						<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="left">
															...
															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left=".2in" margin-right=".2in" margin-top="0" max-width="2.60in" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			<fo:table-column column-width="1.300in"/>
																			<fo:table-column column-width="1.300in"/>
																			<xsl:variable name="altova:CurrContextGrid_3" select="."/>
																			<xsl:variable name="altova:ColumnData"/>
																			<fo:table-body margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																				<xsl:for-each select="LABEL2">
																					<fo:table-row line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																						<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="left">
																								<xsl:for-each select="NAME">
															...
															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left=".25in" margin-right=".1in" margin-top="0" max-width="2.60in" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			<fo:table-column column-width="1.300in"/>
																			<fo:table-column column-width="1.300in"/>
																			<xsl:variable name="altova:CurrContextGrid_4" select="."/>
																			<xsl:variable name="altova:ColumnData"/>
																			<fo:table-body margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																				<xsl:for-each select="LABEL3">
																					<fo:table-row line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																						<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="left">
																								<xsl:for-each select="NAME">
