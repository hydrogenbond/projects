...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;INSPAY1&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="INSPAY1.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.30in" margin-right="0.30in" page-height="8.50in" page-width="11in" margin-top="0.20in" margin-bottom="0">
				<fo:region-body margin-top="0.90in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="0.90in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.30in" margin-right="0.30in" page-height="8.50in" page-width="11in" margin-top="0.20in" margin-bottom="0">
				<fo:region-body margin-top="0.90in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="0.90in"/>
			</fo:simple-page-master>
			...
			<fo:root>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:dc="http://purl.org/dc/elements/1.1/">
								<dc:title>INSTALLER PAYABLES REPORT</dc:title>
								<dc:creator>LJEWELL_20160309</dc:creator>
								<dc:description/>
							</rdf:Description>
							<rdf:Description rdf:about="" xmlns:pdf="http://ns.adobe.com/pdf/1.3/">
								<pdf:Keywords>INSPAY_PRINT_PDF</pdf:Keywords>
							</rdf:Description>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
								...
								<xsl:variable name="altova:table">
									<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row height="0.52in">
												<fo:table-cell font-size="30pt" font-style="italic" font-weight="700" padding="0" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
														</fo:inline>
														<xsl:for-each select="$XML">
															<xsl:for-each select="INSPAY1">
											...
											<fo:table-row height="0.21in">
												<fo:table-cell number-columns-spanned="2" padding="0" display-align="before">
													<fo:block text-align="left">
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="INSPAY1">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="@SEARCH-BRANCH">
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="INSPAY1">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="@INSTALLER-NAME">
																		<altova:inline-container-substitute font-size="9pt">
																			<fo:inline>
																				<xsl:value-of select="string(.)"/>
																			</fo:inline>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block keep-together.within-page="auto" keep-together.within-column="auto" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<altova:line-break/>
							<xsl:variable name="altova:table">
								<fo:table border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-collapse="collapse" border-left-color="gray" border-left-style="solid" border-left-width="thin" border-right-color="gray" border-right-style="solid" border-right-width="thin" font-size="9pt" line-height=".7pt" margin-bottom="0" padding-bottom="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%">
									<fo:table-column column-width="0.300in"/>
									<fo:table-column column-width="0.600in"/>
									<fo:table-column column-width="0.300in"/>
									<fo:table-column column-width="0.300in"/>
									<fo:table-column column-width="3.250in"/>
									<fo:table-column column-width="2.300in"/>
									<fo:table-column column-width="1.110in"/>
									<fo:table-column column-width="1.100in"/>
									<fo:table-column column-width="1.110in"/>
									<xsl:variable name="altova:CurrContextGrid_2" select="."/>
									<xsl:variable name="altova:ColumnData"/>
									<fo:table-header border-collapse="collapse" start-indent="0pt">
										<fo:table-row background-color="#f0f0f0" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="700" height="inherit" line-height="1.0">
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="INSPAY1">
															<xsl:for-each select="COLUMNS">
																<xsl:for-each select="BRANCH-C">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="INSPAY1">
															<xsl:for-each select="COLUMNS">
																<xsl:for-each select="RATE-C">
																	<altova:inline-container-substitute text-align="right">
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
															</xsl:for-each>
											...
											<xsl:for-each select="INSPAY1">
												<xsl:for-each select="REPORT-DATA">
													<xsl:for-each select="BRANCH">
														<xsl:choose>
															<xsl:when test="exists( JOB/JOBNUM )">
																<fo:table-row border-bottom-style="none" height="auto" margin-bottom="0pt" margin-top="0pt" padding-bottom="0pt" padding-top="0pt">
																	<fo:table-cell number-columns-spanned="9" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<xsl:variable name="altova:table">
																				<fo:table border-bottom-style="none" border-bottom-width="thin" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" line-height="7pt" table-layout="fixed" margin-left="(100% - 100%) div 2" width="100%">
																					<fo:table-column column-width="0.300in"/>
																					<fo:table-column column-width="0.600in"/>
																					<fo:table-column column-width="0.300in"/>
																					<fo:table-column column-width="0.350in"/>
																					<fo:table-column column-width="3.250in"/>
																					<fo:table-column column-width="2.230in"/>
																					<fo:table-column column-width="1.100in"/>
																					<fo:table-column column-width="1.100in"/>
																					<fo:table-column column-width="1.100in"/>
																					...
																					<fo:table-body start-indent="0pt">
																						<xsl:for-each select="JOB">
																							<fo:table-row border-bottom-style="none" height="auto" keep-with-next.within-page="always" keep-with-next.within-column="always">
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
																									<fo:block text-align="left">
																										<xsl:for-each select="BRANCH">
																											<altova:inline-container-substitute>
																												<xsl:apply-templates/>
																							...
																							<fo:table-row border-bottom-style="none" height="auto" keep-with-previous.within-page="always" keep-with-previous.within-column="always">
																								<fo:table-cell number-columns-spanned="4" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
																									<fo:block text-align="left">
																										<fo:inline>
																											<xsl:text>Posted Date:</xsl:text>
																										</fo:inline>
																										<xsl:for-each select="POSTDATE">
																											<altova:inline-container-substitute>
																												<xsl:apply-templates/>
																											</altova:inline-container-substitute>
																										</xsl:for-each>
																								...
																								<fo:table-cell number-columns-spanned="5" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
																									<fo:block text-align="left">
																										<fo:inline>
														...
														<xsl:choose>
															<xsl:when test="exists( BRANCH-TOTAL )">
																<fo:table-row border-bottom-style="none" border-top-color="gray" height="0.15in" line-height="3pt">
																	<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
																		<fo:block text-align="left"/>
																	</fo:table-cell>
																	<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" padding="2pt" display-align="center">
																	...
																	<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" padding="2pt" display-align="center">
																		<fo:block text-align="right">
																			<xsl:for-each select="BRANCH-TOTAL">
																				<altova:inline-container-substitute>
																					<xsl:apply-templates/>
																				</altova:inline-container-substitute>
																			</xsl:for-each>
																	...
																	<fo:table-cell number-columns-spanned="2" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="700" padding="2pt" display-align="center">
																		<fo:block text-align="right">
																			<xsl:for-each select="JOB-AMT">
																				<altova:inline-container-substitute>
																					<xsl:apply-templates/>
							...
							<altova:line-break/>
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" keep-together.within-page="auto" keep-together.within-column="auto" keep-with-previous.within-page="always" keep-with-previous.within-column="always" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" page-break-after="avoid" table-omit-footer-at-break="true" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" margin-left="(100% - 100%) div 2" width="100%" border-spacing="2pt">
									<fo:table-column column-width="proportional-column-width(1)"/>
									<fo:table-column column-width="6.070in"/>
									<fo:table-column column-width="3in"/>
									<fo:table-column column-width="1.110in"/>
									<fo:table-column column-width="0.030in"/>
									<xsl:variable name="altova:CurrContextGrid_4" select="."/>
									<xsl:variable name="altova:ColumnData"/>
									<fo:table-body bottom="0" keep-together.within-page="auto" keep-together.within-column="auto" keep-with-previous.within-page="always" keep-with-previous.within-column="always" margin-bottom="0" padding-bottom="0" table-omit-footer-at-break="true" start-indent="0pt">
										<fo:table-row height="0.10in" keep-together.within-page="always" keep-together.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" line-height=".10in" text-align="right">
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="700" padding="2pt" display-align="before">
												<fo:block text-align="right">
													<fo:inline font-size="9pt">
														<xsl:text>Total Amount Selected For Payment: </xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thin" font-weight="700" padding="2pt" display-align="before">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="INSPAY1">
															<xsl:for-each select="TOTALS">
																<xsl:for-each select="PAYMENT-TOT">
																	<altova:inline-container-substitute font-size="9pt">
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
										...
										<fo:table-row height="0.09in" keep-together.within-page="always" keep-together.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" line-height="1pt" text-align="right">
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
										...
										<fo:table-row height=".10in" keep-together.within-page="always" keep-together.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" line-height=".10in" text-align="right">
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<fo:inline font-size="9pt">
														<xsl:text>Deductions</xsl:text>
													</fo:inline>
													<fo:inline>
														<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
													</fo:inline>
													<fo:inline font-size="9pt">
														<xsl:text>Loan (Incr):</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="INSPAY1">
															<xsl:for-each select="TOTALS">
																<xsl:for-each select="DEDUCTIONS">
																	<xsl:for-each select="LOAN">
																		<altova:inline-container-substitute font-size="9pt" text-align="right">
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
																</xsl:for-each>
										...
										<fo:table-row height=".10in" keep-together.within-page="always" keep-together.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" line-height=".10in" text-align="right">
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<fo:inline font-size="9pt">
														<xsl:text>Retainage (Used):</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
										...
										<fo:table-row height=".10in" keep-together.within-page="always" keep-together.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" line-height=".10in" text-align="right">
											...
											<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="INSPAY1">
															<xsl:for-each select="TOTALS">
																<xsl:for-each select="DEDUCTIONS">
																	<xsl:for-each select="OTH-COMMENT">
																		<altova:inline-container-substitute font-size="9pt">
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
										...
										<fo:table-row height=".10in" keep-together.within-page="always" keep-together.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" line-height=".10in" text-align="right">
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="700" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<fo:inline font-size="9pt">
														<xsl:text>Total Amount to Pay Installer:</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="solid" border-top-width="thin" font-weight="700" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="INSPAY1">
															<xsl:for-each select="TOTALS">
																<xsl:for-each select="TOT-TO-PAY">
																	<altova:inline-container-substitute font-size="9pt" text-align="right">
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
