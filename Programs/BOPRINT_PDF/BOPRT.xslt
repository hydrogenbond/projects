...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;BOPRT&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_BOPRT.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.30in" margin-right="0.30in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.30in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="1.30in"/>
			...
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.30in" margin-right="0.30in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.30in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="1.30in"/>
			</fo:simple-page-master>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:dc="http://purl.org/dc/elements/1.1/">
								<dc:title>BUILD ORDER</dc:title>
								<dc:creator>LJEWELL_20160505</dc:creator>
								<dc:description>BO_PRINT</dc:description>
							</rdf:Description>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
							...
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table font-size="9pt" width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="7.390in"/>
											...
											<fo:table-row height="1.60in">
												<fo:table-cell font-size="10pt" padding="0" display-align="center">
													<fo:block text-align="left">
														<xsl:if test="exists( BOPRT/HEADER-INFO/LOGO-INFO/LOGO-POS )">
															<xsl:variable name="altova:sUrlOrData" select="BOPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC"/>
															...
															<fo:external-graphic scaling="non-uniform">
																<xsl:variable name="sText-align">
																	<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																		<xsl:with-param name="sValue" select="BOPRT/HEADER-INFO/LOGO-INFO/LOGO-POS"/>
																	</xsl:call-template>
																</xsl:variable>
																...
																<xsl:variable name="sContent-height">
																	<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																		<xsl:with-param name="sValue" select="BOPRT/HEADER-INFO/LOGO-INFO/LOGO-HEIGHT"/>
																	</xsl:call-template>
																</xsl:variable>
																...
																<xsl:attribute name="src">
																	...
																	<xsl:call-template name="altova:double-backslash">
																		<xsl:with-param name="text">
																			<xsl:value-of select="string(BOPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC)"/>
																		</xsl:with-param>
																		<xsl:with-param name="text-length">
																			<xsl:value-of select="string-length(string(BOPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC))"/>
																		</xsl:with-param>
																	</xsl:call-template>
																	<xsl:text>)</xsl:text>
																</xsl:attribute>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="none" border-style="none" border-top-style="none" font-size="9pt" line-height=".8" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									<fo:table-column column-width="3.420in"/>
									<fo:table-column column-width="2.380in"/>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row line-height=".7" margin-left="0" margin-right="0">
											<fo:table-cell number-rows-spanned="4" border-bottom-style="none" border-left-style="none" border-style="none" border-top-style="none" font-size="15pt" font-weight="700" border="solid 1pt gray" padding="2pt" display-align="before">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BLOCK1">
																	<xsl:for-each select="TITLE-REPORT">
													...
													<altova:line-break/>
													<xsl:if test="exists(BOPRT/HEADER-INFO/BO-BARCODE)">
														<xsl:variable name="altova:sUrlOrData" select="BOPRT/HEADER-INFO/BO-BARCODE"/>
														<xsl:variable name="altova:seqWidthHeight" as="xs:integer*">
															<xsl:choose use-when="function-available('altovaext:get-width-and-height-from-image-data')">
																<xsl:when test="unparsed-text-available($altova:sUrlOrData, 'x-binarytobase64')">
																	<xsl:sequence select="altovaext:get-width-and-height-from-image-data(xs:base64Binary(unparsed-text($altova:sUrlOrData, 'x-binarytobase64')))"/>
														...
														<fo:external-graphic>
															...
															<xsl:attribute name="src">
																...
																<xsl:call-template name="altova:double-backslash">
																	<xsl:with-param name="text">
																		<xsl:value-of select="string(BOPRT/HEADER-INFO/BO-BARCODE)"/>
																	</xsl:with-param>
																	<xsl:with-param name="text-length">
																		<xsl:value-of select="string-length(string(BOPRT/HEADER-INFO/BO-BARCODE))"/>
																	</xsl:with-param>
																</xsl:call-template>
																<xsl:text>)</xsl:text>
															</xsl:attribute>
											...
											<fo:table-cell number-rows-spanned="4" border-bottom-style="none" border-left-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="right"/>
											</fo:table-cell>
							...
							<altova:line-break/>
							<xsl:variable name="altova:table">
								<fo:table font-size="9pt" line-height=".8" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									<fo:table-column column-width="0.110in"/>
									<fo:table-column column-width="0.240in"/>
									...
									<fo:table-column column-width="0.530in"/>
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row>
											<fo:table-cell number-columns-spanned="15" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
										...
										<fo:table-row>
											<fo:table-cell border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-HEADER2">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
												...
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-HEADER3">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
											...
											<fo:table-cell border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
											</fo:table-cell>
											<fo:table-cell border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
												...
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-HEADER4">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											...
											<fo:table-cell number-columns-spanned="9" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-STYLE">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-COLOR">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" text-decoration="underline" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-STYNUM-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-STYNUM">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" text-decoration="underline" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-COLNUM-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-COLNUM">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
										...
										<fo:table-row>
											<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" text-decoration="underline" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-DESC-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-BUILDQTY-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-BUILDQTY">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-WIDTH-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-WIDTH">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-CUTAMT-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-CUTAMT">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-LENGTH-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-LENGTH">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-CUTAMT2-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-CUTAMT2">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
										...
										<fo:table-row>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-SIDEMARK-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
											...
											<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-SIDEMARK">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX1">
																	<xsl:for-each select="BOX1-DATA">
																		<xsl:for-each select="BOX1-NOTES-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell number-columns-spanned="10" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:variable name="altova:table">
														<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-family="Courier New" font-size="10pt" line-height=".8" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
															<fo:table-column column-width="proportional-column-width(1)"/>
																...
																<xsl:for-each select="$XML">
																	<xsl:for-each select="BOPRT">
																		<xsl:for-each select="HEADER-INFO">
																			<xsl:for-each select="BOX1">
																				<xsl:for-each select="BOX1-DATA">
																					<xsl:for-each select="BOX1-NOTES">
																						<xsl:for-each select="BOX1-NOTE">
																							<fo:table-row>
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																									<fo:block text-align="left">
																										<altova:inline-container-substitute>
							...
							<xsl:variable name="altova:table">
								<fo:table font-size="9pt" line-height=".8" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									...
									<fo:table-column column-width="2.250in"/>
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row>
											<fo:table-cell number-columns-spanned="7" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
															...
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-ORDER-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-ORDER">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-CUSTID-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-CUSTID">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-ORDDATE-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-ORDDATE">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-CUSTNAME-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-CUSTNAME">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SLSID-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SLSID">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-CONTACT-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-CONTACT">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SOLDTO-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SOLDTO">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SHIPTO-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SHIPTO">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SOLDTO-ADD1"/>
																	</xsl:for-each>
																</xsl:for-each>
															</xsl:for-each>
														</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SHIPTO-ADD1">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SOLDTO-ADD2">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SHIPTO-ADD2">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SOLDTO-CITY">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SOLDTO-ZIP">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SHIPTO-CITY">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SHIPTO-ZIP">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SOLDTO-COUNTRY">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="BOX2">
																	<xsl:for-each select="BOX2-DATA">
																		<xsl:for-each select="BOX2-SHIPTO-COUNTRY">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
							...
							<xsl:variable name="altova:table">
								<fo:table font-size="9pt" line-height=".8" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									...
									<fo:table-column column-width="3.490in"/>
									<fo:table-column column-width="proportional-column-width(1)"/>
									<fo:table-column column-width="1in"/>
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row>
											<fo:table-cell number-columns-spanned="5" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="MATERIAL-HEADER">
																<xsl:for-each select="MAT-HEADER-TITLE">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="MATERIAL-HEADER">
																<xsl:for-each select="MAT-HEADER-PC">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="MATERIAL-HEADER">
																<xsl:for-each select="MAT-HEADER-STYLE">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="MATERIAL-HEADER">
																<xsl:for-each select="MAT-HEADER-COLOR">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="MATERIAL-HEADER">
																<xsl:for-each select="MAT-HEADER-QTYE">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
											...
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="right">
													<xsl:for-each select="$XML">
														<xsl:for-each select="BOPRT">
															<xsl:for-each select="MATERIAL-HEADER">
																<xsl:for-each select="MAT-HEADER-QTYT">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
							...
							<xsl:apply-templates select="$altova:table" mode="altova:copy-table"/>
							<altova:line-break/>
							<xsl:if test="exists( BOPRT/JOB-INFO/JOB-DATA/JOB )">
								<altova:line-break/>
								<altova:page-break/>
								<xsl:if test="exists( BOPRT/HEADER-INFO/LOGO-INFO/LOGO-POS )">
									<xsl:variable name="altova:sUrlOrData" select="BOPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC"/>
								...
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="0.840in"/>
										<fo:table-column column-width="0.800in"/>
										<fo:table-column column-width="0.920in"/>
										...
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-header start-indent="0pt">
											<fo:table-row height="0.14in" text-decoration="underline">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOPRT">
																<xsl:for-each select="JOB-INFO">
																	<xsl:for-each select="JOB-HEADER">
																		<xsl:for-each select="JOB-JOBNUM-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOPRT">
																<xsl:for-each select="JOB-INFO">
																	<xsl:for-each select="JOB-HEADER">
																		<xsl:for-each select="JOB-JOBDATE-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOPRT">
																<xsl:for-each select="JOB-INFO">
																	<xsl:for-each select="JOB-HEADER">
																		<xsl:for-each select="JOB-CONT-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOPRT">
																<xsl:for-each select="JOB-INFO">
																	<xsl:for-each select="JOB-HEADER">
																		<xsl:for-each select="JOB-CUSTID-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOPRT">
																<xsl:for-each select="JOB-INFO">
																	<xsl:for-each select="JOB-HEADER">
																		<xsl:for-each select="JOB-CUSTNAME-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
													...
													<fo:block text-align="center">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOPRT">
																<xsl:for-each select="JOB-INFO">
																	<xsl:for-each select="JOB-HEADER">
																		<xsl:for-each select="JOB-SLSID-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
										...
										<fo:table-body start-indent="0pt">
											<xsl:for-each select="$XML">
												<xsl:for-each select="BOPRT">
													<xsl:for-each select="JOB-INFO">
														<xsl:for-each select="JOB-DATA">
															<xsl:for-each select="JOB">
																<fo:table-row font-size="7pt">
																	<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<xsl:for-each select="JOB-NUM">
																				<altova:inline-container-substitute>
																					<xsl:apply-templates/>
																				</altova:inline-container-substitute>
																			</xsl:for-each>
																	...
																	<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<xsl:for-each select="JOB-CUSTID">
																				<altova:inline-container-substitute>
																					<xsl:apply-templates/>
																				</altova:inline-container-substitute>
																			</xsl:for-each>
