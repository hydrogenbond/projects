...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;CITYACCUM&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_CITYACCUM.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.40in" margin-right="0.40in" page-height="11in" page-width="8.50in" margin-top="0.10in" margin-bottom="0.10in">
				<fo:region-body margin-top="0.30in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="0.30in"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="0.20in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.40in" margin-right="0.40in" page-height="11in" page-width="8.50in" margin-top="0.10in" margin-bottom="0.10in">
				<fo:region-body margin-top="0.30in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="0.30in"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="0.20in"/>
			</fo:simple-page-master>
			...
			<fo:root>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
							...
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="7.500in"/>
										<xsl:variable name="altova:CurrContextGrid_1" select="."/>
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell font-size="10pt" font-weight="bold" margin-bottom="0" margin-top="0" padding="0" padding-bottom="0" padding-top="0" display-align="center">
													<fo:block text-align="center">
														<fo:inline>
															<xsl:text>Rollmaster Schedule</xsl:text>
														</fo:inline>
														<altova:line-break/>
														<xsl:for-each select="$XML">
															<xsl:for-each select="CITYACCUM">
														...
														<xsl:if test="exists( CITYACCUM/HEADER-INFO/ENDDATE )">
															<fo:inline>
					...
					<fo:static-content flow-name="odd-page-footer">
						<fo:block-container height="0.20in" overflow="hidden" display-align="after">
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="5.890in"/>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block>
							...
							<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<xsl:variable name="altova:CurrContextGrid_3" select="."/>
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-header start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
																...
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			...
																			<xsl:for-each select="ACCUMLISTTODISPLAY">
																			...
																			<fo:table-body start-indent="0pt">
																				<fo:table-row>
																					...
																					<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 5 ]"/>
																					<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																						...
																						<fo:table-cell number-columns-spanned="2" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																							<xsl:variable name="sBackground-color">
																								<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																									<xsl:with-param name="sValue" select="if(ACCUMTODISPLAY= &quot;C&quot;) then &quot;orange&quot; else &quot;#bcb397&quot;"/>
																								</xsl:call-template>
																							</xsl:variable>
																							...
																							<fo:block text-align="center">
																								<xsl:for-each select="ACCUMTODISPLAY">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																					...
																					<fo:table-cell border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left"/>
																					</fo:table-cell>
																				</fo:table-row>
																				<fo:table-row>
																					<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<fo:inline>
																					...
																					<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																						<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																						<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																						<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="center">
																								<fo:inline>
																									<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Q</xsl:text>
																								</fo:inline>
																					...
																					<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-collapse="collapse" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="center">
																							<fo:inline>
																								<xsl:text>Total Jobs By City</xsl:text>
																							</fo:inline>
																						</fo:block>
																					</fo:table-cell>
																				</fo:table-row>
								...
								<xsl:apply-templates select="$altova:table" mode="altova:copy-table"/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray">
										<fo:table-column column-width="2in"/>
													...
													<xsl:for-each select="CITYINFO">
														<xsl:for-each select="CITY">
															<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-style="none" border-right-width="thick" border-top-style="none" border-top-width="thick" margin-bottom="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="left">
																...
																<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-style="none" border-right-width="thick" border-top-style="none" border-top-width="thick" margin-bottom="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="left">
																		<xsl:variable name="altova:table">
																			<fo:table border-bottom-style="none" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																				<xsl:for-each select="ACCUM-LEVEL">
																					<fo:table-column column-width="0.750in"/>
																					<fo:table-column column-width="0.750in"/>
																				</xsl:for-each>
																				<fo:table-column column-width="1in"/>
																				...
																				<xsl:variable name="altova:ColumnData">
																					<xsl:for-each select="ACCUM-LEVEL">
																						<altova:Element altova:sDesignElemId="8" altova:sNodeId="{generate-id(.)}" altova:sDocumentUri="{document-uri(root(.))}"/>
																					</xsl:for-each>
																				</xsl:variable>
																				<fo:table-body margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																					<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																						<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 8 ]"/>
																						<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																							<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																							<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																							<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-style="none" border-right-width="thick" border-top-style="none" border-top-width="thick" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="right">
																									<xsl:for-each select="ACCUM-QTY">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-style="none" border-top-width="thick" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="center">
																									<xsl:for-each select="ACCUM-JOBTOT">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																						...
																						<fo:table-cell border-bottom-style="none" border-bottom-width="thick" border-left-style="none" border-left-width="thick" border-right-style="none" border-right-width="thick" border-top-style="none" border-top-width="thick" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																							<fo:block text-align="center">
																								<xsl:for-each select="CITYJOBTOT">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																...
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			...
																			<fo:table-body start-indent="0pt">
																				<fo:table-row>
																					<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<fo:inline>
																					...
																					<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 11 ]"/>
																					<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																						<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																						<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																						<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
																							<xsl:variable name="sBackground-color">
																								<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																									<xsl:with-param name="sValue" select="if(ACCUMTODISPLAY= &quot;C&quot;) then &quot;orange&quot; else &quot;#bcb397&quot;"/>
																								</xsl:call-template>
																							...
																							<fo:block text-align="right">
																								<xsl:for-each select="ACCUMTODISPLAY-QTY">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																						...
																						<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-style="none" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
																							<xsl:variable name="sBackground-color">
																								<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																									<xsl:with-param name="sValue" select="if(ACCUMTODISPLAY= &quot;C&quot;) then &quot;orange&quot; else &quot;#bcb397&quot;"/>
																								</xsl:call-template>
																							...
																							<fo:block text-align="center">
																								<xsl:for-each select="ACCUMTODISPLAY-JOBS">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																					...
																					<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="center">
																							<xsl:for-each select="$XML">
																								<xsl:for-each select="CITYACCUM">
																									<xsl:for-each select="TOTAL-NUMBER-OF-JOBS">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
