...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;WOPRT2&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="WOPRT2.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	...
	<xsl:variable name="altova:CssImages">
		<altova:CssImage altova:sUrl="file:///G:/_WORK/_XML_Printing/duplicate3.png"/>
	</xsl:variable>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="{WOPRT2/HEADER-INFO/LOGO-INFO/LOGO-POS}">
													<xsl:if test="exists( WOPRT2/HEADER-INFO/LOGO-INFO/LOGO-LOC )">
														<xsl:variable name="altova:sUrlOrData" select="WOPRT2/HEADER-INFO/LOGO-INFO/LOGO-LOC"/>
														...
														<fo:external-graphic margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" scaling="non-uniform">
															<xsl:variable name="sText-align">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="WOPRT2/HEADER-INFO/LOGO-INFO/LOGO-POS"/>
																</xsl:call-template>
															</xsl:variable>
															...
															<xsl:variable name="sContent-height">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="WOPRT2/HEADER-INFO/LOGO-INFO/LOGO-HEIGHT"/>
																</xsl:call-template>
															</xsl:variable>
															...
															<xsl:attribute name="src">
																...
																<xsl:call-template name="altova:double-backslash">
																	<xsl:with-param name="text">
																		<xsl:value-of select="string(WOPRT2/HEADER-INFO/LOGO-INFO/LOGO-LOC)"/>
																	</xsl:with-param>
																	<xsl:with-param name="text-length">
																		<xsl:value-of select="string-length(string(WOPRT2/HEADER-INFO/LOGO-INFO/LOGO-LOC))"/>
																	</xsl:with-param>
																</xsl:call-template>
																<xsl:text>)</xsl:text>
															</xsl:attribute>
									...
									<fo:table-body start-indent="0pt">
															...
															<xsl:for-each select="HEADER-INFO">
																<xsl:for-each select="USER-INFO">
																	<xsl:for-each select="SUBTITLE">
																		<altova:inline-container-substitute color="#787878" font-style="italic">
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
																</xsl:for-each>
										...
										<fo:table-row line-height=".7" margin-left="0" margin-right="0">
											<fo:table-cell number-columns-spanned="2" number-rows-spanned="2" border-bottom-style="none" border-left-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:if test="exists( WOPRT2/HEADER-INFO/JOB-BARCODE )">
														<xsl:variable name="altova:sUrlOrData" select="WOPRT2/HEADER-INFO/JOB-BARCODE"/>
														<xsl:variable name="altova:seqWidthHeight" as="xs:integer*">
															<xsl:choose use-when="function-available('altovaext:get-width-and-height-from-image-data')">
																<xsl:when test="unparsed-text-available($altova:sUrlOrData, 'x-binarytobase64')">
																	<xsl:sequence select="altovaext:get-width-and-height-from-image-data(xs:base64Binary(unparsed-text($altova:sUrlOrData, 'x-binarytobase64')))"/>
														...
														<fo:external-graphic content-height=".45in" scaling="non-uniform" content-width="1.5in">
															<xsl:attribute name="src">
																...
																<xsl:call-template name="altova:double-backslash">
																	<xsl:with-param name="text">
																		<xsl:value-of select="string(WOPRT2/HEADER-INFO/JOB-BARCODE)"/>
																	</xsl:with-param>
																	<xsl:with-param name="text-length">
																		<xsl:value-of select="string-length(string(WOPRT2/HEADER-INFO/JOB-BARCODE))"/>
																	</xsl:with-param>
																</xsl:call-template>
																<xsl:text>)</xsl:text>
															</xsl:attribute>
							...
							<altova:line-break/>
							<xsl:variable name="altova:table">
								<fo:table background-image="url(file:///G:/_WORK/_XML_Printing/duplicate3.png)" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-style="none" border-top-style="none" font-size="8pt" line-height=".9" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
									<fo:table-column column-width="0.750in"/>
									<fo:table-column column-width="3.230in"/>
									<xsl:if test="exists( WOPRT2/HEADER-INFO/BOX2/BOX2-HEADER)">
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row>
											...
											<xsl:if test="$altova:CurrContextGrid_5/(exists( WOPRT2/HEADER-INFO/BOX2/BOX2-HEADER))">
							...
							<xsl:if test="exists( WOPRT2/HEADER-INFO/CONOTES/CONOTE )">
								<altova:line-break/>
								<xsl:variable name="altova:table">
							...
							<xsl:if test="exists( WOPRT2/MATERIAL/BUNDLE/MATERIAL-LINE )">
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table line-height=".11in" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
										<fo:table-column column-width="0.410in"/>
										<fo:table-column column-width="1.290in"/>
										...
										<fo:table-header start-indent="0pt">
											<fo:table-row background-color="#f0f0f0">
												<fo:table-cell number-columns-spanned="8" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="center">
														<xsl:for-each select="$XML">
															<xsl:for-each select="WOPRT2">
											...
											<fo:table-row border-bottom-color="gray" border-bottom-style="solid" font-size="10pt">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
											...
											<xsl:for-each select="$XML">
												<xsl:for-each select="WOPRT2">
													<xsl:for-each select="MATERIAL">
														<fo:table-row>
															<fo:table-cell number-columns-spanned="8" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-omit-header-at-break="true" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																			<fo:table-column column-width="proportional-column-width(1)"/>
																			<fo:table-column column-width="proportional-column-width(1)"/>
																			...
																			<fo:table-body start-indent="0pt">
																				<xsl:for-each select="BUNDLE">
																					<fo:table-row border-bottom-style="none" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-color="black" border-top-style="solid" border-top-width="thick" font-size="9pt">
																						<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																							<fo:block text-align="left">
																								<fo:inline>
																									<xsl:text>&#160;</xsl:text>
																								</fo:inline>
																						...
																						<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																							<fo:block text-align="left">
																								<xsl:for-each select="BO-SEQ-INFO">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																					...
																					<fo:table-row border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thick" border-left-color="black" border-left-style="solid" border-left-width="thick" border-right-color="black" border-right-style="solid" border-right-width="thick" border-top-style="none">
																						<fo:table-cell number-columns-spanned="2" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																							<fo:block text-align="left">
																								<xsl:variable name="altova:table">
																									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" line-height=".11in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																										<fo:table-column column-width="0.360in"/>
																										<fo:table-column column-width="1.770in"/>
																										<fo:table-column column-width="1.520in"/>
																										<fo:table-column column-width="2.020in"/>
																										...
																										<fo:table-body border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" start-indent="0pt">
																											<xsl:for-each select="MATERIAL-LINE">
																												<fo:table-row border-collapse="collapse" border-top-color="gray" border-top-style="solid" border-top-width="thin" height=".07in">
																													...
																													<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="0" margin-right="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																														<fo:block text-align="left">
																															<xsl:variable name="altova:table">
																																	...
																																	<fo:table-body start-indent="0pt">
																																		<xsl:for-each select="MAT-COMMENT-LINE">
																																			<xsl:for-each select="MAT-COMM">
																																				<fo:table-row border-left-style="none" border-right-style="none" border-top-style="none">
																												...
																												<fo:table-row border-collapse="collapse" height=".07in" keep-with-previous.within-page="always" keep-with-previous.within-column="always">
																													...
																													<fo:table-cell number-columns-spanned="2" border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-previous.within-page="always" keep-with-previous.within-column="always" margin-left="0" margin-right="0" padding-bottom="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																														<fo:block text-align="left">
																													...
																													<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-previous.within-page="always" keep-with-previous.within-column="always" margin-left="0" margin-right="0" padding-bottom="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																														<fo:block text-align="left">
																													...
																													<fo:table-cell number-columns-spanned="4" border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-previous.within-page="always" keep-with-previous.within-column="always" margin-left="0" margin-right="0" padding-bottom="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																														<fo:block text-align="left">
																												...
																												<fo:table-row border-collapse="collapse" height=".07in" keep-with-previous.within-page="always" keep-with-previous.within-column="always">
																													...
																													<fo:table-cell number-columns-spanned="4" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																														<fo:block text-align="left">
																															<xsl:if test="exists( ORDER/ORDER-LINE )">
																																<xsl:variable name="altova:table">
																																	<fo:table font-size="8pt" line-height=".8" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																																		...
																																		<fo:table-column column-width="3.270in"/>
																																		...
																																		<fo:table-header start-indent="0pt">
																																			...
																																			<fo:table-row border-bottom-style="solid" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																													...
																													<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																														<fo:block text-align="right"/>
																													</fo:table-cell>
																												</fo:table-row>
																												<xsl:choose>
																													<xsl:when test="exists( MAT-LINE-BARCODE )">
																														<fo:table-row border-collapse="collapse" height=".07in" keep-with-previous.within-page="always" keep-with-previous.within-column="always">
																															...
																															<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																<fo:block text-align="right">
																																	<xsl:if test="exists( MAT-LINE-BARCODE )">
																																		...
																																		<fo:external-graphic margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" content-height=".24in" scaling="non-uniform" content-width="1.5in">
																																			<xsl:attribute name="src">
																																				<xsl:text>url(</xsl:text>
																																				<xsl:call-template name="altova:double-backslash">
																																					<xsl:with-param name="text">
   ...
   &quot;none&quot;"/>
																																					...
																																					<fo:table-cell number-columns-spanned="4" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																						<fo:block text-align="left">
																																				...
																																				<fo:table-row line-height=".12in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																																					<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																						<fo:block text-align="left"/>
																																					</fo:table-cell>
																												...
																												<fo:table-row border-bottom-style="none" border-bottom-width="thin" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" height=".07in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																													<fo:table-cell number-columns-spanned="8" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="0" margin-right="0" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																														<fo:block text-align="left">
																																	...
																																	<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																																		...
																																		<fo:table-body start-indent="0pt">
																																			<fo:table-row border-bottom-style="none" border-collapse="collapse" border-left-style="none" height=".07in" margin-top="0" padding-top="0">
																																				<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="0" margin-right="0" margin-top="0" padding-left="0" padding-right="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																					<fo:block text-align="left"/>
																																				</fo:table-cell>
																																				<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="0" margin-right="0" margin-top="0" padding-left="0" padding-right="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="before" altova:is-body-cell="true">
																																					<fo:block text-align="left">
																																						<fo:inline>
																																							<xsl:text>&#160;</xsl:text>
																																						</fo:inline>
							...
							<xsl:if test="exists( WOPRT2/MATERIAL-SUMMARY/PROD-SUMMARY )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
							...
							<xsl:if test="exists( WOPRT2/LABOR/LABOR-LINE )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
							...
							<xsl:if test="exists( WOPRT2/HEADER-INFO/SEP-SHEET-FLAG )">
								<altova:page-break/>
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-style="none" border-top-style="none" font-size="9pt" line-height=".9" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										...
										<fo:table-header start-indent="0pt">
											<fo:table-row>
												...
												<xsl:if test="$altova:CurrContextGrid_23/(exists( WOPRT2/HEADER-INFO/BOX2/BOX2-HEADER ))">
													<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-style="none" border-top-style="none" font-weight="700" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="after">
														<fo:block text-align="center"/>
													</fo:table-cell>
												</xsl:if>
							...
							<xsl:if test="exists( WOPRT2/INSTALLER-INFO/INS-INFO )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9PT" line-height=".13in" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
							...
							<altova:line-break/>
							<xsl:if test="exists( WOPRT2/MULTI-INFO/MULTI-DATA/MULTI-LINE )">
								<altova:page-break/>
								<altova:line-break/>
								<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
									<xsl:for-each select="$XML">
