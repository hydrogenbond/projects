...
<!--Designed and generated by Altova StyleVision Enterprise Edition 2015 rel. 3 sp1 (x64) - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.4in" margin-right="0.4in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="0.49in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.4in" margin-right="0.4in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="0.49in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-even-first" margin-left="0.4in" margin-right="0.4in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header-first" overflow="hidden" extent="0.49in"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="0.30in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd-first" margin-left="0.4in" margin-right="0.4in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header-first" overflow="hidden" extent="0.49in"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="0.30in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-even-last" margin-left="0.4in" margin-right="0.4in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="0.49in"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="0.30in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd-last" margin-left="0.4in" margin-right="0.4in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.49in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="0.49in"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="0.30in"/>
			</fo:simple-page-master>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:xmp="http://ns.adobe.com/xap/1.0/">
								<xmp:CreatorTool>Altova StyleVision Enterprise Edition 2015 rel. 3 sp1 (x64) (http://www.altova.com)</xmp:CreatorTool>
							</rdf:Description>
						</rdf:RDF>
					</x:xmpmeta>
				</fo:declarations>
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
						...
						<fo:block-container overflow="hidden" display-align="before">
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" table-layout="fixed" width="100%" border-spacing="2pt">
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block>
							...
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="none" border-left-style="none" border-style="none" border-top-style="none" font-size="9pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
							...
							<xsl:apply-templates select="$altova:table" mode="altova:copy-table"/>
							<altova:line-break/>
							<fo:block-container height="1.50in" width="15.39in" overflow="hidden">
								<fo:block-container absolute-position="absolute" height="4.09in" left="0in" top="0in" width="3.78in" overflow="hidden">
									<fo:block>
										<xsl:variable name="altova:table">
											<fo:table border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-style="none" font-size="9pt" line-height=".9" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
												<fo:table-column column-width="0.750in"/>
												<fo:table-column column-width="2.750in"/>
												<xsl:variable name="altova:CurrContextGrid_4" select="."/>
												<xsl:variable name="altova:ColumnData"/>
												<fo:table-header start-indent="0pt">
													<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
														<fo:table-cell number-columns-spanned="2" background-color="#e1e1e1" border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-color="gray" border-top-style="solid" font-weight="700" border="solid 1pt gray" padding="2pt" display-align="after">
																		...
																		<xsl:for-each select="HEADER-INFO">
																			<xsl:for-each select="BOX1">
																				<xsl:for-each select="BOX1-HEADER">
																					<altova:inline-container-substitute line-height="0">
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																			</xsl:for-each>
												...
												<fo:table-body start-indent="0pt">
													<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
														<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="none" border-right-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
															<fo:block text-align="right"/>
														</fo:table-cell>
																			...
																			<xsl:for-each select="BOX1">
																				<xsl:for-each select="BOX1-DATA">
																					<xsl:for-each select="BOX1-NAME">
																						<altova:inline-container-substitute border-bottom-style="none" line-height="0">
																							<xsl:apply-templates/>
																						</altova:inline-container-substitute>
																					</xsl:for-each>
																				</xsl:for-each>
													...
													<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
														...
														<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="$XML">
																	<xsl:for-each select="WOPRINT">
																		<xsl:for-each select="HEADER-INFO">
													...
													<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
														<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
															<fo:block text-align="right"/>
														</fo:table-cell>
														<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-color="gray" border-right-style="solid" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
															<fo:block text-align="left"/>
														</fo:table-cell>
													</fo:table-row>
												</fo:table-body>
								...
								<fo:block-container absolute-position="absolute" height="2.65in" left="3.80in" top="0in" width="8.90in" overflow="hidden">
									<fo:block>
										<xsl:if test="exists( WOPRINT/HEADER-INFO/BOX2/BOX2-DATA/CODE-T )">
											<xsl:variable name="altova:table">
												<fo:table border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-style="none" font-size="9pt" line-height=".9" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
													<fo:table-column column-width="0.750in"/>
													...
													<fo:table-header start-indent="0pt">
														<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															<fo:table-cell number-columns-spanned="3" background-color="#e1e1e1" border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-style="none" border-top-color="gray" border-top-style="solid" font-weight="700" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="after">
																<fo:block text-align="center">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="WOPRINT">
																			<xsl:for-each select="HEADER-INFO">
													...
													<fo:table-body start-indent="0pt">
														<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-style="none" border-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="after">
																<fo:block text-align="right">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="WOPRINT">
																			<xsl:for-each select="HEADER-INFO">
															...
															<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="none" border-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<fo:inline>
																		<xsl:text>&#160; </xsl:text>
																	</fo:inline>
														...
														<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															<fo:table-cell border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-style="none" border-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="right">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="WOPRINT">
																			<xsl:for-each select="HEADER-INFO">
														...
														<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															...
															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="none" border-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="WOPRINT">
																			<xsl:for-each select="HEADER-INFO">
																...
																<fo:block text-align="left">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="WOPRINT">
																			<xsl:for-each select="HEADER-INFO">
																				<xsl:for-each select="BLOCK5">
																					<xsl:for-each select="MISC-PHONE">
																						<altova:inline-container-substitute>
																							<xsl:apply-templates/>
																						</altova:inline-container-substitute>
																					</xsl:for-each>
														...
														<fo:table-row height=".09IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
															<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-style="none" border-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="right"/>
															</fo:table-cell>
															<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-color="gray" border-right-style="none" border-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left"/>
															</fo:table-cell>
															<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-color="gray" border-right-style="solid" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left"/>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
							...
							<xsl:apply-templates select="$altova:table" mode="altova:copy-table"/>
							<fo:block text-align="center">
								<fo:leader rule-thickness=".2pt" leader-pattern="rule" leader-length="100%"/>
							</fo:block>
							<xsl:if test="exists( WOPRINT/HEADER-INFO/CONOTES/CONOTE )">
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" font-size="small" line-height=".7" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="7.700in"/>
							...
							<xsl:if test="exists( WOPRINT/MATERIAL/MATERIAL-LINE )">
								...
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table font-size="9pt" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
										<fo:table-column column-width="0.400in"/>
										<fo:table-column column-width="0.400in"/>
										<fo:table-column column-width="1.360in"/>
										<fo:table-column column-width="0.010in"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										...
										<fo:table-column column-width="0.160in"/>
										<fo:table-column column-width="1.670in"/>
										<fo:table-column column-width="0.220in"/>
										<fo:table-column column-width="0.400in"/>
										<xsl:variable name="altova:CurrContextGrid_8" select="."/>
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-header start-indent="0pt">
											<fo:table-row background-color="#e1e1e1" border-bottom-color="gray" border-bottom-style="solid" border-collapse="collapse" font-weight="bold" height=".07in">
												<fo:table-cell number-columns-spanned="15" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="WOPRINT">
												...
												<xsl:for-each select="WOPRINT">
													<xsl:for-each select="MATERIAL">
														<xsl:for-each select="MATERIAL-LINE">
															<fo:table-row border-collapse="collapse" border-top-color="gray" height=".07in">
																...
																<fo:table-cell number-columns-spanned="14" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																		<xsl:variable name="altova:table">
																			<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																				<fo:table-column column-width="proportional-column-width(1)"/>
																				...
																				<fo:table-body start-indent="0pt">
																					<xsl:for-each select="MAT-COMMENT-LINE">
																						<xsl:for-each select="MAT-COMM">
																							<fo:table-row>
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																									<fo:block text-align="left">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
															...
															<fo:table-row border-collapse="collapse" border-top-color="gray" border-top-style="solid" height=".07in">
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																...
																<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" text-decoration="underline" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																...
																<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																...
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="right"/>
																</fo:table-cell>
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left"/>
															...
															<fo:table-row border-collapse="collapse" height=".07in">
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-previous.within-page="always" keep-with-previous.within-column="always" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left"/>
																</fo:table-cell>
																<fo:table-cell border-bottom-color="gray" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-previous.within-page="always" keep-with-previous.within-column="always" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="right">
																...
																<fo:table-cell number-columns-spanned="3" border-bottom-color="gray" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-previous.within-page="always" keep-with-previous.within-column="always" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																...
																<fo:table-cell number-columns-spanned="7" border-bottom-color="gray" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" keep-with-previous.within-page="always" keep-with-previous.within-column="always" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
															...
															<fo:table-row border-collapse="collapse" height=".07in">
																<fo:table-cell number-columns-spanned="15" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																		<xsl:variable name="altova:table">
																				...
																				<fo:table-body border-bottom-style="none" start-indent="0pt">
																					<xsl:for-each select="ROLL-LINES">
																						<xsl:for-each select="ROLL">
																							<fo:table-row border-collapse="collapse" border-spacing="0" height=".07in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																									<fo:block text-align="left"/>
																								</fo:table-cell>
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="solid" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																									<fo:block text-align="left">
																								...
																								<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="solid" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																									<fo:block text-align="right">
																								...
																								<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="solid" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																									<fo:block text-align="center">
																							...
																							<fo:table-row border-bottom-style="none" border-collapse="collapse" border-spacing="0" height=".07in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																									<fo:block text-align="left"/>
																								</fo:table-cell>
															...
															<fo:table-row border-bottom-color="gray" border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-right-style="none" border-top-style="none" height=".07in" margin-bottom="0" margin-top="0">
																<fo:table-cell number-columns-spanned="15" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																				...
																				<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																					...
																					<fo:table-body start-indent="0pt">
																						<fo:table-row border-bottom-style="none" border-collapse="collapse" border-left-style="none" height=".07in" margin-top="0" padding-top="0">
																							...
																							<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before" altova:is-body-cell="true">
																								<fo:block text-align="left">
																									<fo:inline>
																										<xsl:text>&#160;</xsl:text>
																									</fo:inline>
																							...
																							<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="after" altova:is-body-cell="true">
																								<fo:block text-align="left">
																									<xsl:variable name="altova:table">
																									...
																									<xsl:apply-templates select="$altova:table" mode="altova:copy-table"/>
																									<xsl:variable name="altova:table">
																										<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="body-empty">
																											<fo:table-column column-width="proportional-column-width(1)"/>
							...
							<xsl:if test="exists( WOPRINT/MATERIAL-SUMMARY/PROD-SUMMARY )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
							...
							<xsl:if test="exists( WOPRINT/LABOR/LABOR-LINE )">
								...
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table font-size="9pt" line-height=".7" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
										<fo:table-column column-width="0.400in"/>
										...
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-header start-indent="0pt">
											<fo:table-row background-color="#e1e1e1" height="0.07in">
												<fo:table-cell number-columns-spanned="3" border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="WOPRINT">
												...
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												...
												<fo:table-cell number-columns-spanned="2" border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row border-bottom-color="gray" border-bottom-style="solid" font-weight="normal" height="0.07in">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="normal" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="WOPRINT">
																<xsl:for-each select="LABOR-HEADER">
												...
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="normal" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="WOPRINT">
																<xsl:for-each select="LABOR-HEADER">
													...
													<xsl:for-each select="LABOR">
														<xsl:for-each select="LABOR-LINE">
															<fo:table-row border-bottom-style="none" height="0.07in">
																...
																<fo:table-cell number-columns-spanned="8" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																		<xsl:variable name="altova:table">
																			<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																				<fo:table-column column-width="proportional-column-width(1)"/>
															...
															<fo:table-row border-top-color="gray" border-top-style="solid" height="0.07in">
																...
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" text-decoration="underline" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																...
																<fo:table-cell number-columns-spanned="4" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" text-decoration="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
																...
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" text-decoration="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left"/>
																</fo:table-cell>
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" text-decoration="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
															...
															<fo:table-row border-bottom-color="gray" border-bottom-style="solid" height="0.07in">
																<fo:table-cell number-columns-spanned="9" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																	<fo:block text-align="left">
							...
							<xsl:if test="exists( WOPRINT/HEADER-INFO/SEP-SHEET-FLAG )">
								<altova:page-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-style="none" border-top-style="none" font-size="9pt" line-height=".09in" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="0.750in"/>
										<fo:table-column column-width="3.100in"/>
										<fo:table-column column-width="0.070in"/>
										<fo:table-column column-width="0.750in"/>
										<fo:table-column column-width="1.440in"/>
										<fo:table-column column-width="1.560in"/>
										...
										<fo:table-header start-indent="0pt">
											<fo:table-row>
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-style="none" border-top-style="none" font-weight="700" border="solid 1pt gray" padding="2pt" display-align="after">
													<fo:block text-align="center"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="3" background-color="#e1e1e1" border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-style="none" border-top-color="gray" border-top-style="solid" font-weight="700" border="solid 1pt gray" padding="2pt" display-align="after">
													<fo:block text-align="center">
														<xsl:for-each select="$XML">
															<xsl:for-each select="WOPRINT">
																<xsl:for-each select="HEADER-INFO">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												...
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>&#160; </xsl:text>
														</fo:inline>
											...
											<fo:table-row>
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-style="none" border-top-style="none" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:element name="fo:block-container">
															<xsl:attribute name="height">
																<xsl:value-of select="'100%'"/>
											...
											<fo:table-row>
												...
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-color="gray" border-right-style="solid" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
														<fo:inline>
															<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
														</fo:inline>
												...
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-color="gray" border-right-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-left-style="none" border-right-color="gray" border-right-style="solid" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
							...
							<xsl:if test="exists( WOPRINT/MULTI-INFO/MULTI-DATA/MULTI-LINE )">
								...
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="small" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="0.500in"/>
										<fo:table-column column-width="1in"/>
										<fo:table-column column-width="2in"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
													...
													<xsl:for-each select="MULTI-INFO">
														<xsl:for-each select="MULTI-DATA">
															<xsl:for-each select="MULTI-LINE">
																<fo:table-row background-color="#e1e1e1" border-bottom-color="gray" border-bottom-style="solid" border-left-color="gray" border-left-style="solid" border-right-color="gray" border-right-style="solid" border-top-color="gray" border-top-style="solid" height=".07IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																		...
																		<fo:block text-align="left">
																			<xsl:for-each select="$XML">
																				<xsl:for-each select="WOPRINT">
																					<xsl:for-each select="MULTI-INFO">
																						<xsl:for-each select="MULTI-HEADER-INFO">
																							<xsl:for-each select="MULTI-PC-T">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																		...
																		<fo:block text-align="left">
																			<xsl:for-each select="$XML">
																				<xsl:for-each select="WOPRINT">
																					<xsl:for-each select="MULTI-INFO">
																						<xsl:for-each select="MULTI-HEADER-INFO">
																							<xsl:for-each select="MULTI-STYLE-T">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																		...
																		<fo:block text-align="left">
																			<xsl:for-each select="$XML">
																				<xsl:for-each select="WOPRINT">
																					<xsl:for-each select="MULTI-INFO">
																						<xsl:for-each select="MULTI-HEADER-INFO">
																							<xsl:for-each select="MULTI-COLOR-T">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																		...
																		<fo:block text-align="left">
																			<xsl:for-each select="$XML">
																				<xsl:for-each select="WOPRINT">
																					<xsl:for-each select="MULTI-INFO">
																						<xsl:for-each select="MULTI-HEADER-INFO">
																							<xsl:for-each select="MULTI-ROLL-T">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																		...
																		<fo:block text-align="left">
																			<xsl:for-each select="$XML">
																				<xsl:for-each select="WOPRINT">
																					<xsl:for-each select="MULTI-INFO">
																						<xsl:for-each select="MULTI-HEADER-INFO">
																							<xsl:for-each select="MULTI-DYE-T">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																...
																<fo:table-row height=".07IN" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																				...
																				<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".7" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																					...
																					<fo:table-body start-indent="0pt">
																						<xsl:for-each select="MULTI-PICKTICKET">
																							<xsl:for-each select="MULTI-PICKTICKET">
																								<fo:table-row height="0.15in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																									<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block text-align="left">
