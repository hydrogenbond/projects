...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;POPRINT&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="POPRINT.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.3in" margin-right="0.3in" page-height="11in" page-width="8.50in" margin-top=".20in" margin-bottom="0.1in">
				<fo:region-body margin-top="3.90in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="3.90in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.3in" margin-right="0.3in" page-height="11in" page-width="8.50in" margin-top=".20in" margin-bottom="0.1in">
				<fo:region-body margin-top="3.90in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="3.90in"/>
			</fo:simple-page-master>
			...
			<fo:root>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							...
							<rdf:Description rdf:about="" xmlns:pdf="http://ns.adobe.com/pdf/1.3/">
								<pdf:Keywords>PO_PRT_PDF</pdf:Keywords>
							</rdf:Description>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
							...
							<fo:block font-size="9pt">
								<xsl:variable name="altova:table">
									<fo:table margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="7.350in"/>
										<fo:table-column column-width="10%"/>
										<xsl:variable name="altova:CurrContextGrid_1" select="."/>
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row height="2.50in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
												<fo:table-cell font-size="10pt" padding="0" display-align="center">
													<fo:block text-align="left">
																...
																<fo:table-body start-indent="0pt">
																	<fo:table-row height="1.60in">
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="{POPRINT/HEADER-INFO/LOGO-INFO/LOGO-POS}">
																				<xsl:if test="exists( POPRINT/HEADER-INFO/LOGO-INFO/LOGO-LOC )">
																					<xsl:variable name="altova:sUrlOrData" select="POPRINT/HEADER-INFO/LOGO-INFO/LOGO-LOC"/>
																					...
																					<fo:external-graphic scaling="non-uniform">
																						<xsl:variable name="sText-align">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="POPRINT/HEADER-INFO/LOGO-INFO/LOGO-POS"/>
																							</xsl:call-template>
																						</xsl:variable>
																						...
																						<xsl:variable name="sContent-height">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="POPRINT/HEADER-INFO/LOGO-INFO/LOGO-HEIGHT"/>
																							</xsl:call-template>
																						</xsl:variable>
																						...
																						<xsl:attribute name="src">
																							...
																							<xsl:call-template name="altova:double-backslash">
																								<xsl:with-param name="text">
																									<xsl:value-of select="string(POPRINT/HEADER-INFO/LOGO-INFO/LOGO-LOC)"/>
																								</xsl:with-param>
																								<xsl:with-param name="text-length">
																									<xsl:value-of select="string-length(string(POPRINT/HEADER-INFO/LOGO-INFO/LOGO-LOC))"/>
																								</xsl:with-param>
																							</xsl:call-template>
																							<xsl:text>)</xsl:text>
																						</xsl:attribute>
																				...
																				<xsl:variable name="altova:table">
																					<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty" altova:hide-cols="empty">
																						<fo:table-column column-width="proportional-column-width(1)"/>
																						<xsl:variable name="altova:CurrContextGrid_3" select="."/>
																						<xsl:variable name="altova:ColumnData"/>
																						<fo:table-body start-indent="0pt">
																							<fo:table-row line-height=".8">
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".8" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																									<fo:block text-align="center">
																										<xsl:for-each select="$XML">
																											<xsl:for-each select="POPRINT">
																												<xsl:for-each select="HEADER-INFO">
																													<xsl:for-each select="LOGO-INFO">
																														<xsl:for-each select="LOGO-LINE1">
																									...
																									<fo:block text-align="center">
																										<xsl:for-each select="$XML">
																											<xsl:for-each select="POPRINT">
																												<xsl:for-each select="HEADER-INFO">
																													<xsl:for-each select="LOGO-INFO">
																														<xsl:for-each select="LOGO-LINE2">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
																									...
																									<fo:block text-align="center">
																										<xsl:for-each select="$XML">
																											<xsl:for-each select="POPRINT">
																												<xsl:for-each select="HEADER-INFO">
																													<xsl:for-each select="LOGO-INFO">
																														<xsl:for-each select="LOGO-LINE3">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
																									...
																									<fo:block text-align="center">
																										<xsl:for-each select="$XML">
																											<xsl:for-each select="POPRINT">
																												<xsl:for-each select="HEADER-INFO">
																													<xsl:for-each select="LOGO-INFO">
																														<xsl:for-each select="LOGO-LINE4">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
																									...
																									<fo:block text-align="center">
																										<xsl:for-each select="$XML">
																											<xsl:for-each select="POPRINT">
																												<xsl:for-each select="HEADER-INFO">
																													<xsl:for-each select="LOGO-INFO">
																														<xsl:for-each select="LOGO-LINE5">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
														...
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="2.980in"/>
																						...
																						<xsl:for-each select="HEADER-INFO">
																							<xsl:for-each select="USER-INFO">
																								<xsl:for-each select="TITLE">
																									<altova:inline-container-substitute font-size="15pt" font-weight="bold">
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																							</xsl:for-each>
																			...
																			<fo:block text-align="center">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="HEADER-INFO">
																							<xsl:for-each select="USER-INFO">
																								<xsl:for-each select="PO-TITLE">
																									<altova:inline-container-substitute font-size="12pt" font-style="italic">
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																							</xsl:for-each>
																								...
																								<xsl:for-each select="PO">
																									<xsl:for-each select="MATERIAL-HEADER">
																										<xsl:for-each select="BLOCK1">
																											<xsl:for-each select="BLK1-COMPANY">
																												<altova:inline-container-substitute>
																													<xsl:apply-templates/>
																												</altova:inline-container-substitute>
																											</xsl:for-each>
																								...
																								<xsl:for-each select="PO">
																									<xsl:for-each select="MATERIAL-HEADER">
																										<xsl:for-each select="BLOCK2">
																											<xsl:for-each select="BLK2-BRANCH">
																												<altova:inline-container-substitute>
																													<xsl:apply-templates/>
																												</altova:inline-container-substitute>
																											</xsl:for-each>
														...
														<altova:line-break/>
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" line-height=".8" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																<fo:table-column column-width="0.780in"/>
																<fo:table-column column-width="3.110in"/>
																<fo:table-column column-width="0.090in"/>
																<fo:table-column column-width="0.780in"/>
																<fo:table-column column-width="3.140in"/>
																<xsl:variable name="altova:CurrContextGrid_5" select="."/>
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-body start-indent="0pt">
																	<fo:table-row>
																		<fo:table-cell number-columns-spanned="2" background-color="#f0f0f0" border-bottom-style="solid" border-left-color="black" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="center">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
																		...
																		<fo:table-cell number-columns-spanned="2" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="center">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
																	...
																	<fo:table-row>
																		<fo:table-cell border-bottom-style="none" border-left-color="black" border-left-style="solid" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="right">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="solid" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="right">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
																	...
																	<fo:table-row>
																		<fo:table-cell border-bottom-style="solid" border-left-color="black" border-left-style="solid" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before" altova:is-body-cell="true">
																			<fo:block text-align="right">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
																		...
																		<fo:table-cell border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
																		...
																		<fo:table-cell border-bottom-style="solid" border-left-style="solid" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before" altova:is-body-cell="true">
																			<fo:block text-align="right">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="POPRINT">
																						<xsl:for-each select="MATERIAL">
														...
														<altova:line-break/>
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" line-height=".09in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="0.800in"/>
																<fo:table-column column-width="2.860in"/>
																<fo:table-column column-width="1.110in"/>
																<fo:table-column column-width="2.930in"/>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block font-size="9pt" height=".09in" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".09in" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										...
										<fo:table-column column-width="2.010in"/>
										<fo:table-column column-width="0.630in"/>
										<fo:table-column column-width="0.700in"/>
										<fo:table-column column-width="0.460in"/>
										<fo:table-column column-width="0.280in"/>
										<fo:table-column column-width="0.200in"/>
										<fo:table-column column-width="0.570in"/>
										<fo:table-column column-width="0.500in"/>
										<fo:table-column column-width="0.660in"/>
										<fo:table-column column-width="1.240in"/>
										...
										<fo:table-header start-indent="0pt">
											<fo:table-row>
												...
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
											...
											<fo:table-row border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="thin" border-left-style="none" border-style="none" border-top-style="none">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
											...
											<xsl:for-each select="$XML">
												<xsl:for-each select="POPRINT">
													<xsl:for-each select="MATERIAL">
														<xsl:for-each select="BRANCH">
															<xsl:for-each select="PO">
																<xsl:for-each select="PO-LINE">
																	<fo:table-row background-color="#f0f0f0" keep-with-next.within-page="always" keep-with-next.within-column="always">
																		<fo:table-cell number-columns-spanned="6" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="none" border-top-style="solid" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-BOX-HEADER">
																					<xsl:for-each select="MAT-BOX-H-LINE-T">
																				...
																				<xsl:for-each select="MAT-BOX-HEADER">
																					<xsl:for-each select="MAT-BOX-H-LINE">
																						<altova:inline-container-substitute font-weight="bold">
																							<xsl:apply-templates/>
																						</altova:inline-container-substitute>
																					</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="2" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="solid" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-BOX-HEADER">
																					<xsl:for-each select="MAT-BOX-H-ORD">
																						<altova:inline-container-substitute font-weight="bold">
																							<xsl:apply-templates/>
																						</altova:inline-container-substitute>
																					</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="3" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="solid" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-BOX-HEADER">
																					<xsl:for-each select="MAT-BOX-H-DATE">
																						<altova:inline-container-substitute font-weight="bold">
																							<xsl:apply-templates/>
																						</altova:inline-container-substitute>
																					</xsl:for-each>
																	...
																	<fo:table-row keep-with-next.within-page="always" keep-with-next.within-column="always">
																		<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																		...
																		<fo:table-cell number-columns-spanned="9" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="solid" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left"/>
																		</fo:table-cell>
																	</fo:table-row>
																	<fo:table-row keep-with-previous.within-page="always" keep-with-previous.within-column="always">
																		<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																		...
																		<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																		...
																		<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-QTYORD-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="solid" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-QTYORD">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																	...
																	<fo:table-row>
																		<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-STYLE-SKU-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-STYLE-SKU">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-COLORNUM-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-COLORNUM">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-COST-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="solid" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-EXT-QTY">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																	...
																	<fo:table-row>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-SHIP-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-SHIPVIA-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="solid" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-SHIPVIA">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																	...
																	<fo:table-row>
																		<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-DESC-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-MEMO-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																	...
																	<fo:table-row>
																		<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="right">
																				<xsl:for-each select="MAT-FREIGHT-TERMS-T">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																					<fo:inline>
																		...
																		<fo:table-cell number-columns-spanned="4" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="MAT-FREIGHT-TERMS">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																	...
																	<fo:table-row>
																		...
																		<fo:table-cell number-columns-spanned="10" border-bottom-style="none" border-left-style="none" border-right-style="solid" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:if test="exists( POLINE-NOTES/POL-NOTES )">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																							<fo:table-column column-width="proportional-column-width(1)"/>
																							...
																							<fo:table-body start-indent="0pt">
																								<xsl:for-each select="POLINE-NOTES">
																									<xsl:for-each select="POL-NOTES">
																										<fo:table-row>
																											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																												<fo:block text-align="left">
																													<altova:inline-container-substitute>
																														<xsl:apply-templates/>
																													</altova:inline-container-substitute>
																	...
																	<fo:table-row border-bottom-style="solid">
																		<fo:table-cell number-columns-spanned="11" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:if test="exists( POLINE-POINTERS/POINTER/POINTER-WH )">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																							...
																							<fo:table-header start-indent="0pt">
																								<fo:table-row>
																									<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block text-align="right">
																											<xsl:for-each select="POLINE-POINTERS">
																												<xsl:for-each select="PNTR-HDR">
																													<xsl:for-each select="PNTR-HDR-BR">
																														<altova:inline-container-substitute text-decoration="underline">
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																									...
																									<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block text-align="right">
																											<xsl:for-each select="POLINE-POINTERS">
																												<xsl:for-each select="PNTR-HDR">
																													<xsl:for-each select="PNTR-HDR-ORD">
																														<altova:inline-container-substitute text-decoration="underline">
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																									...
																									<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block text-align="left">
																											<xsl:for-each select="POLINE-POINTERS">
																												<xsl:for-each select="PNTR-HDR">
																													<xsl:for-each select="PNTR-HDR-CUST">
																														<altova:inline-container-substitute text-decoration="underline">
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																									...
																									<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block text-align="left">
																											<xsl:for-each select="POLINE-POINTERS">
																												<xsl:for-each select="PNTR-HDR">
																													<xsl:for-each select="PNTR-HDR-QTY">
																														<altova:inline-container-substitute text-decoration="underline">
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																								...
																								<xsl:for-each select="POLINE-POINTERS">
																									<xsl:for-each select="POINTER">
																										<fo:table-row>
																											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																												<fo:block text-align="right">
																													<xsl:for-each select="POINTER-WH">
																														<altova:inline-container-substitute>
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																											...
																											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																												<fo:block text-align="right">
																													<xsl:for-each select="POINTER-ORD">
																														<altova:inline-container-substitute>
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																											...
																											<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																												<fo:block text-align="left">
																													<xsl:for-each select="POINTER-SHIP">
																														<altova:inline-container-substitute>
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																											...
																											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-left="0" padding-right="0" border="solid 1pt gray" padding="2pt" display-align="center">
																												<fo:block text-align="left">
																													<xsl:for-each select="POINTER-RES">
																														<altova:inline-container-substitute>
																															<xsl:apply-templates/>
																														</altova:inline-container-substitute>
																													</xsl:for-each>
																	...
																	<fo:table-row line-height=".06IN">
																		<fo:table-cell number-columns-spanned="11" border-bottom-style="none" border-left-style="none" border-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<altova:line-break/>
																			</fo:block>
																		</fo:table-cell>
							...
							<xsl:if test="exists( POPRINT/MATERIAL/BRANCH/PO/PO-TOTAL )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
										<fo:table-column column-width="4.650in"/>
										<fo:table-column column-width="3.250in"/>
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												...
												<fo:table-cell border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
													<fo:block text-align="center">
														<xsl:for-each select="$XML">
															<xsl:for-each select="POPRINT">
																<xsl:for-each select="MATERIAL">
							...
							<altova:line-break/>
							<xsl:if test="exists( POPRINT/MATERIAL/BRANCH/PO/MATERIAL-HEADER/PONOTES/PONOTE )">
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
										<fo:table-column column-width="proportional-column-width(1)"/>
												...
												<xsl:for-each select="POPRINT">
													<xsl:for-each select="MATERIAL">
														<xsl:for-each select="BRANCH">
															<xsl:for-each select="PO">
																<xsl:for-each select="MATERIAL-HEADER">
																	<xsl:for-each select="PONOTES">
																		<xsl:for-each select="PONOTE">
																			<fo:table-row>
