...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;OJPRT4&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_OJPRT4.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.60in" margin-right="0.60in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.10in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="1.10in"/>
			...
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.60in" margin-right="0.60in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.10in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="1.10in"/>
			</fo:simple-page-master>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
							...
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="3.090in"/>
										<fo:table-column column-width="1.700in"/>
										<fo:table-column column-width="0.010in"/>
										<fo:table-column column-width="1.890in"/>
										<fo:table-column column-width="0.440in"/>
										<xsl:variable name="altova:CurrContextGrid_1" select="."/>
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell number-columns-spanned="4" font-size="10pt" margin="0" margin-bottom="0" margin-top="0" padding="0" padding-bottom="0" padding-top="0" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell font-size="10pt" font-weight="bold" margin="0" margin-bottom="0" margin-top="0" padding="0" padding-bottom="0" padding-top="0" display-align="center">
													<fo:block text-align="left">
											...
											<fo:table-row>
												<fo:table-cell number-columns-spanned="4" font-size="larger" font-weight="bold" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="center">
														<fo:inline>
															<xsl:text>&#160;&#160;&#160; Inventory Required For Other Branches</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell font-size="larger" font-weight="bold" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row>
											...
											<fo:table-row>
												<fo:table-cell font-size="x-small" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>Branch: </xsl:text>
														</fo:inline>
														<xsl:for-each select="$XML">
															<xsl:for-each select="OJPRT4">
												...
												<fo:table-cell number-columns-spanned="2" font-size="x-small" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
											...
											<fo:table-row>
												...
												<fo:table-cell number-columns-spanned="2" font-size="x-small" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>Job Types: </xsl:text>
														</fo:inline>
														<xsl:for-each select="$XML">
															<xsl:for-each select="OJPRT4">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="BEG-TYPE">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
												...
												<fo:table-cell number-columns-spanned="2" font-size="x-small" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>Job Dates: </xsl:text>
														</fo:inline>
														<xsl:for-each select="$XML">
															<xsl:for-each select="OJPRT4">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="BEG-DATE">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
											...
											<fo:table-row>
												<fo:table-cell font-size="x-small" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>Jobs With Cust: </xsl:text>
														</fo:inline>
														<xsl:for-each select="$XML">
															<xsl:for-each select="OJPRT4">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="BEG-CUST">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
												...
												<fo:table-cell number-columns-spanned="2" font-size="x-small" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>Sales ID: </xsl:text>
														</fo:inline>
														<xsl:for-each select="$XML">
															<xsl:for-each select="OJPRT4">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="BEG-SLSID">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
												...
												<fo:table-cell number-columns-spanned="2" font-size="x-small" margin="0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>Install Dates: </xsl:text>
														</fo:inline>
														<xsl:for-each select="$XML">
															<xsl:for-each select="OJPRT4">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="BEG-INSDATE">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="OJPRT4">
																<xsl:for-each select="HEADER-INFO">
																	<xsl:for-each select="END-INSDATE">
																		<fo:inline>
																			<xsl:text> Thru </xsl:text>
																		</fo:inline>
																		<altova:inline-container-substitute>
											...
											<fo:table-row>
												<fo:table-cell font-size="x-small" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell font-size="x-small" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="2" font-size="x-small" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell font-size="x-small" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-right-style="solid" border-right-width="thin" border-top-style="solid" border-top-width="thin" font-size="medium" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
									<fo:table-column column-width="0.490in"/>
									<fo:table-column column-width="0.500in"/>
									<fo:table-column column-width="1.040in"/>
									<fo:table-column column-width="1.130in"/>
									<fo:table-column column-width="0.880in"/>
									<fo:table-column column-width="0.930in"/>
									<fo:table-column column-width="0.600in"/>
									<fo:table-column column-width="1.470in"/>
									<fo:table-column column-width="0.100in"/>
									<xsl:variable name="altova:CurrContextGrid_2" select="."/>
									<xsl:variable name="altova:ColumnData"/>
									<fo:table-header start-indent="0pt">
										<fo:table-row>
											<fo:table-cell background-color="#d2d2d2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text> Branch</xsl:text>
													</fo:inline>
											...
											<fo:table-cell number-columns-spanned="3" background-color="#d2d2d2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text>&#160;&#160; Job Type</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
												...
												<xsl:for-each select="JOBS">
													<xsl:for-each select="REGION">
														<xsl:for-each select="JOB">
															<xsl:choose>
																<xsl:when test="exists( JOB-LINES/JOB-LINE/JOB-LINE/ROLL/ROLL-INFO )">
																	<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="center">
																				<xsl:for-each select="JOB-WHSE">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="right">
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="center">
																				<xsl:for-each select="JOB-INITIALS">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="center">
																				<xsl:for-each select="JOB-SLSREP">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="right">
																				...
																				<xsl:for-each select="JOB-INSTALLDTE">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
															...
															<xsl:choose>
																<xsl:when test="exists( JOB-LINES/JOB-LINE/JOB-LINE/ROLL/ROLL-INFO )">
																	<fo:table-row border-bottom-color="black" border-bottom-style="solid">
																		<fo:table-cell number-columns-spanned="9" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="left">
																				<xsl:variable name="altova:table">
																					<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																						...
																						<fo:table-column column-width="3.200in"/>
																						<fo:table-column column-width="1.230in"/>
																						<fo:table-column column-width="1.750in"/>
																						<xsl:variable name="altova:CurrContextGrid_3" select="."/>
																						<xsl:variable name="altova:ColumnData"/>
																						<fo:table-body start-indent="0pt">
																							<xsl:for-each select="JOB-LINES">
																								<xsl:for-each select="JOB-LINE">
																									<xsl:choose>
																										<xsl:when test="exists( JOB-LINE/ROLL/ROLL-INFO )">
																											<fo:table-row>
																												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="dashed" border-top-width="thin" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="right">
																														<fo:inline>
																															<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
																														</fo:inline>
																														<xsl:for-each select="JOB-LNNUM">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
																												...
																												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="dashed" border-top-width="thin" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																														<fo:inline>
																															<xsl:text>Style: </xsl:text>
																														</fo:inline>
																														<xsl:for-each select="JOB-STYLE">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
																												...
																												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="dashed" border-top-width="thin" font-size="9pt" font-weight="normal" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="right">
																														<fo:inline>
																															<xsl:text>Work Qty: </xsl:text>
																														</fo:inline>
																											...
																											<fo:table-row>
																												...
																												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="left">
																														...
																														<xsl:for-each select="JOB-STATUS">
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																														</xsl:for-each>
																												...
																												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																													<fo:block text-align="right">
																														<xsl:for-each select="JOB-QTYASS">
																															<fo:inline>
																																<xsl:text>Qty Assigned: </xsl:text>
																															</fo:inline>
																															<altova:inline-container-substitute>
																																<xsl:apply-templates/>
																															</altova:inline-container-substitute>
																									...
																									<fo:table-row border-bottom-style="none">
																										<fo:table-cell border-bottom-style="none" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																											<fo:block text-align="left"/>
																										</fo:table-cell>
																										<fo:table-cell number-columns-spanned="3" border-bottom-color="black" border-bottom-style="dashed" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																											<fo:block text-align="left">
																												<xsl:variable name="altova:table">
																													<fo:table border-bottom-color="black" border-bottom-style="none" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-color="black" border-top-style="solid" border-top-width="thin" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																														...
																														<fo:table-column column-width="1.210in"/>
																														<xsl:variable name="altova:CurrContextGrid_4" select="."/>
																														<xsl:variable name="altova:ColumnData"/>
																														<fo:table-body start-indent="0pt">
																															<xsl:for-each select="JOB-LINE">
																																<xsl:for-each select="ROLL">
																																	<xsl:for-each select="ROLL-INFO">
																																		<fo:table-row>
																																			<fo:table-cell border-bottom-color="black" border-bottom-style="none" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																				<fo:block text-align="left">
																																					<fo:inline>
																																			...
																																			<fo:table-cell border-bottom-color="black" border-bottom-style="none" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																				<fo:block text-align="left">
																																					...
																																					<xsl:for-each select="ROLL-TYPESEQ">
																																						<altova:inline-container-substitute>
																																							<xsl:apply-templates/>
																																						</altova:inline-container-substitute>
																																					</xsl:for-each>
																																			...
																																			<fo:table-cell border-bottom-color="black" border-bottom-style="none" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																				<fo:block text-align="right">
																																					<xsl:variable name="altova:sUrlOrData" select="ROLL-BARCODE"/>
																																					...
																																					<fo:external-graphic content-height=".24in" scaling="non-uniform" content-width="1.25in">
																																						<xsl:attribute name="src">
																																							<xsl:text>url(</xsl:text>
																																							<xsl:call-template name="altova:double-backslash">
																																								<xsl:with-param name="text">
																																									<xsl:value-of select="string(ROLL-BARCODE)"/>
																																								</xsl:with-param>
																																								<xsl:with-param name="text-length">
																																									<xsl:value-of select="string-length(string(ROLL-BARCODE))"/>
																																								</xsl:with-param>
																																							</xsl:call-template>
																																							<xsl:text>)</xsl:text>
																																						</xsl:attribute>
																																			...
																																			<fo:table-cell border-bottom-color="black" border-bottom-style="none" border-bottom-width="thin" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																																				<fo:block text-align="right">
																																					<fo:inline>
																																						<xsl:text>Qty Used: </xsl:text>
																																					</fo:inline>
																																					<xsl:for-each select="ROLL-RESERVED">
																																						<altova:inline-container-substitute>
																																							<xsl:apply-templates/>
																																						</altova:inline-container-substitute>
																																					</xsl:for-each>
