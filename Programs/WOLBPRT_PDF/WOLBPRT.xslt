...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;WOLBPRT&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="WOLBPRT.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.40in" margin-right="0.40in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.20in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.40in" margin-right="0.40in" page-height="11in" page-width="8.50in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.20in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
									...
									<xsl:for-each select="LABELS-INFO">
										<xsl:for-each select="LABEL">
											...
											<xsl:variable name="altova:table">
												<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
													<xsl:variable name="sMargin-top">
														<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
															<xsl:with-param name="sValue" select="if ( position() mod 2 = 0 ) then &apos;0.35in&apos; else &apos;&apos;"/>
														</xsl:call-template>
													</xsl:variable>
													<xsl:if test="$sMargin-top != ''">
														<xsl:attribute name="margin-top">
															<xsl:value-of select="$sMargin-top"/>
														</xsl:attribute>
													</xsl:if>
													<fo:table-column column-width="7.690in"/>
													<xsl:variable name="altova:CurrContextGrid_1" select="."/>
													<xsl:variable name="altova:ColumnData"/>
													<fo:table-body start-indent="0pt">
														<fo:table-row border-bottom-style="dotted" border-bottom-width="thick" border-left-style="dotted" border-left-width="thick" border-right-style="dotted" border-right-width="thick" border-top-style="dotted" border-top-width="thick" line-height="3.30in">
															<fo:table-cell line-height="4.15in" border="solid 1pt gray" padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table line-height=".9" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			<fo:table-column column-width="0.010in"/>
																			<fo:table-column column-width="0.930in"/>
																			<fo:table-column column-width="1.080in"/>
																			<fo:table-column column-width="0.530in"/>
																			<fo:table-column column-width="1.580in"/>
																			<fo:table-column column-width="0.350in"/>
																			<fo:table-column column-width="1.170in"/>
																			...
																			<fo:table-body start-indent="0pt">
																				<fo:table-row height="0.25in">
																					<fo:table-cell number-columns-spanned="10" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="center">
																							<fo:inline>
																								<xsl:text>**************Shipping Label*************</xsl:text>
																							</fo:inline>
																						</fo:block>
																					</fo:table-cell>
																				</fo:table-row>
																				...
																				<fo:table-row line-height=".8">
																					...
																					<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<xsl:if test="exists( ../../SHIPPING-INFO/FROM-COUNTRY )">
																								<xsl:for-each select="$XML">
																									<xsl:for-each select="WOLBPRT">
																										<xsl:for-each select="SHIPPING-INFO">
																					...
																					<fo:table-cell number-columns-spanned="4" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<xsl:if test="exists( ../../SHIPPING-INFO/TO-COUNTRY )">
																								<xsl:for-each select="$XML">
																									<xsl:for-each select="WOLBPRT">
																										<xsl:for-each select="SHIPPING-INFO">
																				...
																				<fo:table-row>
																					...
																					<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							...
																							<xsl:for-each select="LABEL-LNNUM">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																					...
																					<fo:table-cell number-columns-spanned="4" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<xsl:for-each select="LABEL-INSTR">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																				...
																				<fo:table-row>
																					...
																					<fo:table-cell number-columns-spanned="4" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<xsl:for-each select="LABEL-JSTAT">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																							...
																							<xsl:for-each select="LABEL-JSTATDESC">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																				...
																				<fo:table-row line-height=".8">
																					...
																					<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							...
																							<xsl:for-each select="LABEL-PCDESC">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																				...
																				<fo:table-row line-height=".8">
																					...
																					<fo:table-cell number-columns-spanned="4" number-rows-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="center">
																							<xsl:if test="exists( LABEL-ROLL-INFO/LABEL-ROLL/LABEL-BARCODE )">
																								<xsl:variable name="altova:sUrlOrData" select="LABEL-ROLL-INFO/LABEL-ROLL/LABEL-BARCODE"/>
																									...
																									<xsl:attribute name="src">
																										...
																										<xsl:call-template name="altova:double-backslash">
																											<xsl:with-param name="text">
																												<xsl:value-of select="string(LABEL-ROLL-INFO/LABEL-ROLL/LABEL-BARCODE)"/>
																											</xsl:with-param>
																											<xsl:with-param name="text-length">
																												<xsl:value-of select="string-length(string(LABEL-ROLL-INFO/LABEL-ROLL/LABEL-BARCODE))"/>
																											</xsl:with-param>
																										</xsl:call-template>
																										<xsl:text>)</xsl:text>
																									</xsl:attribute>
																				...
																				<fo:table-row height="0.15in">
																					...
																					<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="right">
																							<xsl:for-each select="LABEL-ROLL-INFO">
																								<xsl:for-each select="LABEL-ROLL">
																									<xsl:for-each select="ROLL-CUT-B-LA">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																					...
																					<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																						<fo:block text-align="left">
																							<xsl:for-each select="LABEL-ROLL-INFO">
																								<xsl:for-each select="LABEL-ROLL">
																									<xsl:for-each select="ROLL-CUT-B">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<xsl:for-each select="LABEL-ROLL-INFO">
																								<xsl:for-each select="LABEL-ROLL">
																									<xsl:for-each select="ROLL-BOXSHIP-LA">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
