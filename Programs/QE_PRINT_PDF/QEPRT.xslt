...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;QEPRT&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_QEPRT.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.3in" margin-right="0.3in" page-height="11in" page-width="8.50in" margin-top=".20in" margin-bottom="0.1in">
				<fo:region-body margin-top="3.70in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="3.70in"/>
			...
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.3in" margin-right="0.3in" page-height="11in" page-width="8.50in" margin-top=".20in" margin-bottom="0.1in">
				<fo:region-body margin-top="3.70in" margin-bottom="0.20in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="3.70in"/>
			</fo:simple-page-master>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:dc="http://purl.org/dc/elements/1.1/">
								<dc:title>QUOTE</dc:title>
								<dc:creator>LJEWELL_20150505</dc:creator>
								<dc:description/>
							</rdf:Description>
							<rdf:Description rdf:about="" xmlns:pdf="http://ns.adobe.com/pdf/1.3/">
								<pdf:Keywords>QE_PRINT_PDF</pdf:Keywords>
							</rdf:Description>
				...
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
							...
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%" table-layout="fixed" border-spacing="2pt">
										<fo:table-column column-width="7.380in"/>
											...
											<fo:table-row height="2.42in">
												<fo:table-cell font-size="10pt" padding="0" display-align="center">
													<fo:block text-align="left">
																...
																<fo:table-body start-indent="0pt">
																	<fo:table-row height="1.60in">
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="{QEPRT/HEADER-INFO/LOGO-INFO/LOGO-POS}">
																				<xsl:if test="exists( QEPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC )">
																					<xsl:variable name="altova:sUrlOrData" select="QEPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC"/>
																					...
																					<fo:external-graphic scaling="non-uniform">
																						<xsl:variable name="sText-align">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="QEPRT/HEADER-INFO/LOGO-INFO/LOGO-POS"/>
																							</xsl:call-template>
																						</xsl:variable>
																						...
																						<xsl:variable name="sContent-height">
																							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																								<xsl:with-param name="sValue" select="QEPRT/HEADER-INFO/LOGO-INFO/LOGO-HEIGHT"/>
																							</xsl:call-template>
																						</xsl:variable>
																						...
																						<xsl:attribute name="src">
																							...
																							<xsl:call-template name="altova:double-backslash">
																								<xsl:with-param name="text">
																									<xsl:value-of select="string(QEPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC)"/>
																								</xsl:with-param>
																								<xsl:with-param name="text-length">
																									<xsl:value-of select="string-length(string(QEPRT/HEADER-INFO/LOGO-INFO/LOGO-LOC))"/>
																								</xsl:with-param>
																							</xsl:call-template>
																							<xsl:text>)</xsl:text>
																						</xsl:attribute>
																				...
																				<xsl:if test="exists( QEPRT/HEADER-INFO/TEXT-HEADER )">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="QEPRT">
															...
															<xsl:variable name="altova:table">
																<fo:table border-bottom-style="none" border-left-color="black" border-left-style="none" border-right-color="black" border-right-style="none" border-top-color="black" border-top-style="none" font-size="9pt" line-height=".9" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																	...
																	<fo:table-body border-bottom-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																		<fo:table-row height="0.10in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="solid" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																			<fo:table-cell number-rows-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="solid" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="QEPRT">
																							<xsl:for-each select="HEADER-INFO">
																					...
																					<altova:line-break/>
																					<xsl:if test="exists( QEPRT/HEADER-INFO/BLOCK1/MAILTO-COUNTRY )">
																						<xsl:for-each select="$XML">
																							<xsl:for-each select="QEPRT">
																								<xsl:for-each select="HEADER-INFO">
																									<xsl:for-each select="BLOCK1">
																			...
																			<fo:table-cell number-rows-spanned="7" border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="solid" font-weight="normal" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="right">
																					<xsl:variable name="altova:table">
																						<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																							<fo:table-column column-width="1.400in"/>
																							<fo:table-column column-width="2.460in"/>
																							...
																							<fo:table-body start-indent="0pt">
																								<fo:table-row margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0">
																									<fo:table-cell border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="none" font-size="x-large" font-weight="bold" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="right">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="QEPRT">
																													<xsl:for-each select="HEADER-INFO">
																									...
																									<fo:table-cell border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="none" font-size="x-large" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="left">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="QEPRT">
																													<xsl:for-each select="HEADER-INFO">
																								...
																								<fo:table-row margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0">
																									<fo:table-cell background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="none" font-weight="bold" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="right">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="QEPRT">
																													<xsl:for-each select="HEADER-INFO">
																									...
																									<fo:table-cell border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																										<fo:block text-align="left">
																											<xsl:for-each select="$XML">
																												<xsl:for-each select="QEPRT">
																													<xsl:for-each select="HEADER-INFO">
																								...
																								<xsl:choose>
																									<xsl:when test="exists( QEPRT/HEADER-INFO/BLOCK2/SHIPVIA )">
																										<fo:table-row margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0">
																											<fo:table-cell background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="none" font-weight="bold" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																												<fo:block text-align="right">
																													<xsl:for-each select="$XML">
																		...
																		<fo:table-row border-left-color="black" border-left-style="none" height="0.08in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																		</fo:table-row>
																		<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																		...
																		<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			...
																			<fo:table-cell border-bottom-style="solid" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="left"/>
																			</fo:table-cell>
																		</fo:table-row>
																	</fo:table-body>
														...
														<altova:line-break/>
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" line-height=".8" margin="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="0.010in"/>
																<fo:table-column column-width="2.540in"/>
																<fo:table-column column-width="1.660in"/>
																<fo:table-column column-width="0.070in"/>
																<fo:table-column column-width="2.500in"/>
																<fo:table-column column-width="1.100in"/>
																<xsl:variable name="altova:CurrContextGrid_5" select="."/>
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-header start-indent="0pt">
																	<fo:table-row>
																		<fo:table-cell number-columns-spanned="3" background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-weight="bold" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																...
																<fo:table-body start-indent="0pt">
																	...
																	<fo:table-row>
																		...
																		<fo:table-cell number-columns-spanned="2" number-rows-spanned="4" border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:variable name="altova:table">
																					<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																						<fo:table-column column-width="proportional-column-width(1)"/>
																	...
																	<fo:table-row>
																		...
																		<fo:table-cell border-bottom-style="solid" border-left-style="solid" border-right-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				...
																				<altova:line-break/>
																				<xsl:if test="exists( QEPRT/HEADER-INFO/BOX2/BOX2-DATA/BOX2-COUNTRY )">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="QEPRT">
																							<xsl:for-each select="HEADER-INFO">
																								<xsl:for-each select="BOX2">
																		...
																		<fo:table-cell border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="QEPRT">
																						<xsl:for-each select="HEADER-INFO">
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
							<altova:line-break/>
							<xsl:variable name="altova:table">
								<fo:table border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-size="9pt" line-height=".8" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
									...
									<xsl:variable name="altova:ColumnData"/>
									<fo:table-header start-indent="0pt">
										<fo:table-row background-color="#f0f0f0" border-bottom-color="gray" border-bottom-style="solid" border-top-color="gray" border-top-style="solid" height="0.10in">
											<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left"/>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="QEPRT">
											...
											<xsl:for-each select="QEPRT">
												<xsl:for-each select="MATERIAL">
													<xsl:for-each select="BUNDLE">
														<fo:table-row border-top-color="gray" border-top-style="solid" height="0.16in">
															...
															<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" text-decoration="underline" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																<fo:block text-align="left">
														...
														<fo:table-row border-bottom-style="none" border-top-style="none">
															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																<fo:block text-align="left"/>
															</fo:table-cell>
															<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".7" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																			<fo:table-column column-width="0.200in"/>
																			<fo:table-column column-width="0.070in"/>
																			<fo:table-column column-width="0.140in"/>
																			<fo:table-column column-width="2.600in"/>
																			<fo:table-column column-width="0.800in"/>
																			<fo:table-column column-width="1.490in"/>
																			<fo:table-column column-width="0.730in"/>
																			<fo:table-column column-width="1.730in"/>
																			<xsl:variable name="altova:CurrContextGrid_8" select="."/>
																			<xsl:variable name="altova:ColumnData"/>
																			<fo:table-body start-indent="0pt">
																				<xsl:for-each select="BUNDLE-LINES">
																					<fo:table-row>
																						<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-top="0.03in" padding-top="0.03in" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																							<fo:block text-align="left"/>
																						</fo:table-cell>
																						<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-top="0.03in" padding-top="0.03in" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																							<fo:block text-align="left"/>
																						...
																						<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-top="0.03in" padding-top="0.03in" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																							<fo:block text-align="left">
																					...
																					<fo:table-row>
																						...
																						<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																							<fo:block text-align="left">
														...
														<xsl:choose>
															<xsl:when test="exists( BUNDLE-TOTAL )">
																<fo:table-row border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none">
																	...
																	<fo:table-cell number-columns-spanned="7" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																		<fo:block text-align="right">
							...
							<xsl:apply-templates select="$altova:effective-table" mode="altova:copy-table"/>
							<xsl:if test="exists( QEPRT/QUOTE-COMMENTS/QUOTE-COMMENTS )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table keep-together.within-page="always" keep-together.within-column="always" line-height="1.0" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											<xsl:for-each select="$XML">
												<xsl:for-each select="QEPRT">
													<xsl:for-each select="QUOTE-COMMENTS">
														<xsl:for-each select="QUOTE-COMMENTS">
															<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="left">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
							...
							<xsl:if test="exists( QEPRT/CARE )">
								...
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="4.030in"/>
										<fo:table-column column-width="0.010in"/>
										<fo:table-column column-width="3.480in"/>
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
													<fo:block text-align="left">
														<xsl:if test="exists( QEPRT/CC-DEPOSITS/DEPOSIT/CARD-TYPE )">
															<xsl:variable name="altova:table">
																<fo:table border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-family="8pt" line-height=".7" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																	<fo:table-column column-width="0.800in"/>
																	<fo:table-column column-width="0.800in"/>
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
													<fo:block text-align="left">
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="solid" font-size="9pt" line-height="1.2" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="2.530in"/>
							...
							<xsl:if test="exists( QEPRT/NOCARE )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="3.880in"/>
							...
							<xsl:if test="exists( QEPRT/TAX-ID/CUST-TAX-ID )">
								<altova:line-break/>
								<xsl:for-each select="$XML">
									<xsl:for-each select="QEPRT">
							...
							<xsl:if test="exists( QEPRT/PAGE-FOOTER/PAGEFOOTER )">
								<altova:line-break/>
								<altova:line-break/>
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" empty-cells="show" font-size="9pt" keep-together.within-page="always" keep-together.within-column="always" keep-with-next.within-page="always" keep-with-next.within-column="always" keep-with-previous.within-page="always" keep-with-previous.within-column="always" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="proportional-column-width(1)"/>
												...
												<xsl:for-each select="QEPRT">
													<xsl:for-each select="PAGE-FOOTER">
														<xsl:for-each select="PAGEFOOTER">
															<fo:table-row>
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" empty-cells="show" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="left">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
							...
							<xsl:if test="exists( QEPRT/SIGNATURE )">
								<xsl:for-each select="$XML">
									<xsl:for-each select="QEPRT">
							...
							<altova:line-break/>
							<altova:line-break/>
							<xsl:if test="exists( QEPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC )">
								<xsl:variable name="altova:sUrlOrData" select="QEPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC"/>
								<xsl:variable name="altova:seqWidthHeight" as="xs:integer*">
									<xsl:choose use-when="function-available('altovaext:get-width-and-height-from-image-data')">
										<xsl:when test="unparsed-text-available($altova:sUrlOrData, 'x-binarytobase64')">
											<xsl:sequence select="altovaext:get-width-and-height-from-image-data(xs:base64Binary(unparsed-text($altova:sUrlOrData, 'x-binarytobase64')))"/>
								...
								<fo:external-graphic padding-bottom="0" padding-top="0" scaling="non-uniform">
									<xsl:variable name="sText-align">
										<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
											<xsl:with-param name="sValue" select="QEPRT/HEADER-INFO/FOOTER-INFO/FOOTER-POS"/>
										</xsl:call-template>
									</xsl:variable>
									<xsl:if test="$sText-align != ''">
										<xsl:attribute name="text-align">
									...
									<xsl:variable name="sContent-height">
										<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
											<xsl:with-param name="sValue" select="QEPRT/HEADER-INFO/FOOTER-INFO/FOOTER-HEIGHT"/>
										</xsl:call-template>
									</xsl:variable>
									<xsl:if test="$sContent-height != ''">
										<xsl:attribute name="content-height">
									...
									<xsl:attribute name="src">
										...
										<xsl:call-template name="altova:double-backslash">
											<xsl:with-param name="text">
												<xsl:value-of select="string(QEPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC)"/>
											</xsl:with-param>
											<xsl:with-param name="text-length">
												<xsl:value-of select="string-length(string(QEPRT/HEADER-INFO/FOOTER-INFO/FOOTER-LOC))"/>
											</xsl:with-param>
										</xsl:call-template>
										<xsl:text>)</xsl:text>
									</xsl:attribute>
