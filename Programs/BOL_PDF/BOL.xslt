	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.40in" margin-right="0.40in" page-height="11in" page-width="8.50in" margin-top="0.20in" margin-bottom="0.20in">
				<fo:region-body margin-top="2.05in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
			...
			<fo:simple-page-master master-name="page-master-0-even-first" margin-left="0.40in" margin-right="0.40in" page-height="11in" page-width="8.50in" margin-top="0.20in" margin-bottom="0.20in">
				<fo:region-body margin-top="2.05in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header-first" overflow="hidden" extent="2.05in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd-first" margin-left="0.40in" margin-right="0.40in" page-height="11in" page-width="8.50in" margin-top="0.20in" margin-bottom="0.20in">
				<fo:region-body margin-top="2.05in" margin-bottom="0in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header-first" overflow="hidden" extent="2.05in"/>
			</fo:simple-page-master>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:xmp="http://ns.adobe.com/xap/1.0/">
								<xmp:CreatorTool>Altova StyleVision Enterprise Edition 2016 sp1 (x64) (http://www.altova.com)</xmp:CreatorTool>
							</rdf:Description>
						</rdf:RDF>
					</x:xmpmeta>
				</fo:declarations>
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
																	...
																	<fo:table-row height="1in">
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="{QEPRT/HEADER-INFO/LOGO-INFO/LOGO-POS}">
																				<xsl:variable name="altova:sUrlOrData" select="&apos;file:///C:/Users/Lesley/Desktop/EDGEWOODLOGO.png&apos;"/>
																					...
																					<xsl:attribute name="src">
																						...
																						<xsl:call-template name="altova:double-backslash">
																							<xsl:with-param name="text">
																								<xsl:value-of select="string(&apos;file:///C:/Users/Lesley/Desktop/EDGEWOODLOGO.png&apos;)"/>
																							</xsl:with-param>
																							<xsl:with-param name="text-length">
																								<xsl:value-of select="string-length(string(&apos;file:///C:/Users/Lesley/Desktop/EDGEWOODLOGO.png&apos;))"/>
																							</xsl:with-param>
																						</xsl:call-template>
																						<xsl:text>)</xsl:text>
																					</xsl:attribute>
																	...
																	<fo:table-body border-bottom-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" start-indent="0pt">
																		...
																		<fo:table-row margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			...
																			<fo:table-cell background-color="#f0f0f0" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" border-top-style="none" font-weight="bold" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="right">
																					<fo:inline>
																						<xsl:text>Expected Date:</xsl:text>
																					</fo:inline>
																				</fo:block>
																			</fo:table-cell>
																			<fo:table-cell border-bottom-style="solid" border-left-style="none" border-right-style="solid" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block>
							<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="9pt" line-height=".8" margin="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												...
												<fo:table-cell number-rows-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-style="none" border-left-style="solid" border-right-style="none" border-top-style="none" margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
							...
							<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:variable name="altova:table">
									<fo:table font-size="8pt" line-height=".11in" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										...
										<fo:table-header start-indent="0pt">
											<fo:table-row font-weight="bold" line-height="0.12in" padding-bottom="0" padding-top="0">
												...
												<fo:table-cell number-columns-spanned="6" background-color="#f0f0f0" border-bottom-color="black" border-bottom-style="none" border-left-color="black" border-left-style="none" border-right-color="black" border-right-style="none" border-top-color="black" border-top-style="none" padding-bottom=".02in" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="center">
														<fo:inline>
											...
											<fo:table-row line-height="0.12in" padding-bottom="0" padding-top="0">
												...
												<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom=".02in" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="center">
														<fo:inline font-style="italic" font-weight="bold">
															<xsl:text>Undefined Field</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
							...
							<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:variable name="altova:table">
									<fo:table font-size="8pt" line-height=".07in" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="0.340in"/>
										<fo:table-column column-width="2.030in"/>
										<fo:table-column column-width="1.340in"/>
										<fo:table-column column-width="1.830in"/>
										...
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-header start-indent="0pt">
											<fo:table-row border-bottom-color="black" border-bottom-style="solid" border-left-color="black" border-left-style="solid" border-right-color="black" border-right-style="solid" border-top-color="black" border-top-style="solid" font-weight="bold" line-height="0.12in" padding-bottom="0" padding-top="0">
												<fo:table-cell number-columns-spanned="4" background-color="#f0f0f0" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom=".02in" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
												...
												<fo:table-cell background-color="#f0f0f0" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom=".02in" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
														<fo:inline>
										...
										<fo:table-footer start-indent="0pt">
											<fo:table-row>
												<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
														<fo:inline>
															<xsl:text> Total Weight:&#160;&#160;&#160;&#160;&#160; 2169.32 lbs</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
												...
												<xsl:for-each select="PACKSLIP">
													<xsl:for-each select="LABELS-INFO">
														<xsl:for-each select="LABEL">
															<fo:table-row border-top-style="dashed" line-height="0.12in" padding-bottom="0" padding-top="0">
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom=".02in" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="right">
																...
																<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" padding-bottom=".02in" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="left">
																	...
																	<fo:block text-align="right">
																		<xsl:for-each select="LABEL-ROLL-INFO">
																			<xsl:for-each select="LABEL-ROLL">
																				<xsl:for-each select="ROLL-SHIP-A">
																					<altova:inline-container-substitute>
																						<xsl:apply-templates/>
																					</altova:inline-container-substitute>
																				</xsl:for-each>
															...
															<fo:table-row border-bottom-style="dashed" line-height="0.12in" padding-bottom="0" padding-top="0">
																...
																<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="left">
																		<xsl:variable name="altova:table">
																			<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" line-height=".07in" padding-bottom="0" padding-left="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																				<fo:table-column column-width="proportional-column-width(1)"/>
																				<xsl:variable name="altova:CurrContextGrid_7" select="."/>
																				<xsl:variable name="altova:ColumnData"/>
																				<fo:table-body start-indent="0pt">
																					<xsl:for-each select="LABEL-COMMENTS">
																						<xsl:for-each select="LABEL-COMMENT">
																							<fo:table-row>
																								<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																									<fo:block text-align="left">
																										<fo:inline>
																											<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
																										</fo:inline>
							...
							<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" line-height=".10in" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										<fo:table-column column-width="proportional-column-width(1)"/>
												...
												<xsl:for-each select="PACKSLIP">
													<xsl:for-each select="PAGE-FOOTER">
														<xsl:for-each select="PAGEFOOTER">
															<fo:table-row padding-bottom="0" padding-top="0">
																<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																	<fo:block text-align="center">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
