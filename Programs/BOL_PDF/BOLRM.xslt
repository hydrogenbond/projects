...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;BOLRM&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="MERGEFILE_BOL.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.30in" margin-right="0.30in" page-height="11in" page-width="8.50in" margin-top="0.25in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.15in" margin-bottom="-0.10in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="0.15in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.30in" margin-right="0.30in" page-height="11in" page-width="8.50in" margin-top="0.25in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.15in" margin-bottom="-0.10in" column-count="1" column-gap="0.50in"/>
									...
									<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												...
												<fo:table-cell font-size="10pt" font-weight="normal" padding="0" display-align="center">
							...
							<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:variable name="altova:table">
									<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
										...
										<fo:table-column column-width="4.450in"/>
										<fo:table-column column-width="0.150in"/>
										<fo:table-column column-width="0.970in"/>
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="14pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<altova:line-break/>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="14pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION1">
																		<xsl:for-each select="ALT-BOL-TITLE">
											...
											<fo:table-row border-bottom-style="none" font-size="10pt">
													...
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION1">
																		<xsl:for-each select="ALT-BOL-SUBTITLE">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
												...
												<fo:table-cell number-rows-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
														<altova:line-break/>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="3" number-rows-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
											...
											<fo:table-row border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none">
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION2">
																		<xsl:for-each select="ALT-BOL-SECTION2-CARRIER-T">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION2">
																		<xsl:for-each select="ALT-BOL-SECTION2-CARRIER">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<altova:line-break/>
														<xsl:if test="exists( BOLRM/HEADER-INFO/BLOCK4/SECTION-FREIGHT-TERMS )">
															<xsl:for-each select="$XML">
																<xsl:for-each select="BOLRM">
																	<xsl:for-each select="HEADER-INFO">
																		<xsl:for-each select="BLOCK4">
																			<xsl:for-each select="SECTION-FREIGHT-TERMS">
																				<altova:inline-container-substitute>
																					<xsl:apply-templates/>
																				</altova:inline-container-substitute>
																			</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION5">
																		<xsl:for-each select="ALT-BOL-SECTION5-SUBLEVEL">
																			<altova:inline-container-substitute font-size="8pt">
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
																	</xsl:for-each>
											...
											<fo:table-row font-size="10pt" font-weight="bold">
												...
												<fo:table-cell number-columns-spanned="5" background-color="#f0f0f0" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-color="gray" border-top-style="solid" border-top-width="medium" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="SHIPPING-INFO">
											...
											<fo:table-row font-size="10pt" font-weight="bold" line-height=".10in">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row font-size="10pt" line-height=".10in">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="SHIPPING-INFO">
																	<xsl:for-each select="FROM-ADD1">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="SHIPPING-INFO">
																	<xsl:for-each select="FROM-PHONE1">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
											...
											<fo:table-row font-size="10pt" line-height=".10in">
												...
												<fo:table-cell number-columns-spanned="2" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="medium" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:if test="exists( BOLRM/SHIPPING-INFO/FROM-COUNTRY )">
															<xsl:for-each select="$XML">
																<xsl:for-each select="BOLRM">
																	<xsl:for-each select="SHIPPING-INFO">
																		<xsl:for-each select="FROM-COUNTRY">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
												...
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="2" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row border-top-style="none">
												<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty" altova:hide-cols="empty">
																<fo:table-column column-width="proportional-column-width(1)"/>
																<xsl:variable name="altova:CurrContextGrid_3" select="."/>
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-body start-indent="0pt">
																	<fo:table-row>
																		<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-style="none" border-top-color="gray" border-top-style="solid" border-top-width="medium" font-size="8pt" line-height=".12in" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="BOLRM">
																						<xsl:for-each select="ALT-BOL-INFO">
																							<xsl:for-each select="ALT-BOL-SECTION3">
																								<xsl:for-each select="ALT-BOL-SECTION3-DISCLAIMER">
																									<fo:inline>
																										<xsl:text>&#160;</xsl:text>
																									</fo:inline>
																									<altova:line-break/>
											...
											<fo:table-row border-top-style="none">
												<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION4">
																		<xsl:for-each select="ALT-BOL-SECTION4-DISCLAIMER">
											...
											<fo:table-row>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell background-color="#f0f0f0" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-style="none" border-top-color="gray" border-top-style="solid" border-top-width="medium" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
												...
												<fo:table-cell number-columns-spanned="4" background-color="#f0f0f0" border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-color="gray" border-top-style="solid" border-top-width="medium" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>THIRD PARTY BILL TO:&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row line-height=".10in">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-style="none" border-top-style="none" font-size="10pt" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row line-height=".10in">
												...
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="SHIPPING-INFO">
																	<xsl:for-each select="TO-ADD1">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" font-weight="normal" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="SHIPPING-INFO">
																	<xsl:for-each select="TO-CONTACT">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row line-height=".10in">
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-right-width="medium" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="2" border-bottom-style="none" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="SHIPPING-INFO">
																	<xsl:for-each select="TO-PHONE">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
											...
											<fo:table-row line-height=".10in">
												...
												<fo:table-cell number-columns-spanned="2" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="medium" border-left-color="gray" border-left-style="solid" border-left-width="medium" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:if test="exists( BOLRM/SHIPPING-INFO/TO-COUNTRY )">
															<xsl:for-each select="$XML">
																<xsl:for-each select="BOLRM">
																	<xsl:for-each select="SHIPPING-INFO">
																		<xsl:for-each select="TO-COUNTRY">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
												...
												<fo:table-cell border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="2" border-bottom-color="gray" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-color="gray" border-right-style="solid" border-right-width="medium" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="right"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row>
												...
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="5PX" padding-left="5PX" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-left="5PX" padding-left="5PX" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:variable name="altova:table">
															<fo:table font-size="10pt" font-weight="bold" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt" altova:hide-rows="empty">
																<fo:table-column column-width="7.840in"/>
																<xsl:variable name="altova:CurrContextGrid_4" select="."/>
																<xsl:variable name="altova:ColumnData"/>
																<fo:table-body start-indent="0pt">
																	<xsl:choose>
																		<xsl:when test="exists( BOLRM/ALT-BOL-INFO/ALT-BOL-SECTION5/ALT-BOL-SECTION5-SUBLEVEL-SEP )">
																			<fo:table-row>
																				<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".10in" margin-left="5PX" padding-left="5PX" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																					<fo:block text-align="left">
																						<fo:inline>
																							<xsl:text>&#160;</xsl:text>
																						</fo:inline>
																						<xsl:for-each select="$XML">
																							<xsl:for-each select="BOLRM">
																								<xsl:for-each select="ALT-BOL-INFO">
																									<xsl:for-each select="ALT-BOL-SECTION5">
																										<xsl:for-each select="ALT-BOL-SECTION5-SUBLEVEL-SEP">
																											<altova:inline-container-substitute>
																												<xsl:apply-templates/>
																											</altova:inline-container-substitute>
																										</xsl:for-each>
																	...
																	<xsl:choose>
																		<xsl:when test="exists( BOLRM/ALT-BOL-INFO/ALT-BOL-SECTION5/ALT-BOL-SECTION5-ORDERBY )">
																			<fo:table-row>
																				<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".10in" margin-left="5PX" padding-left="5PX" border="solid 1pt gray" padding="2pt" display-align="center" altova:is-body-cell="true">
																					<fo:block text-align="left">
																						<fo:inline>
																						...
																						<xsl:for-each select="$XML">
																							<xsl:for-each select="BOLRM">
																								<xsl:for-each select="ALT-BOL-INFO">
																									<xsl:for-each select="ALT-BOL-SECTION5">
																										<xsl:for-each select="ALT-BOL-SECTION5-ORDERBY-T">
																											<altova:inline-container-substitute>
																												<xsl:apply-templates/>
																											</altova:inline-container-substitute>
																										</xsl:for-each>
																						...
																						<xsl:for-each select="$XML">
																							<xsl:for-each select="BOLRM">
																								<xsl:for-each select="ALT-BOL-INFO">
																									<xsl:for-each select="ALT-BOL-SECTION5">
																										<xsl:for-each select="ALT-BOL-SECTION5-ORDERBY">
																											<altova:inline-container-substitute>
																												<xsl:apply-templates/>
																											</altova:inline-container-substitute>
																										</xsl:for-each>
											...
											<fo:table-row>
												<fo:table-cell number-columns-spanned="6" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:if test="exists( BOLRM/ALT-BOL-INFO/SECTION-FILL-FORM )">
															<xsl:variable name="altova:table">
																<fo:table margin-bottom="0" margin-right="0" margin-top="0" padding-bottom="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																	<fo:table-column column-width="1.040in"/>
																	<fo:table-column column-width="3.500in"/>
																	...
																	<fo:table-header start-indent="0pt">
																		<fo:table-row background-color="#f0f0f0" line-height=".05in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell border-bottom-style="none" font-size="8pt" font-weight="bold" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																			...
																			<fo:table-cell number-columns-spanned="2" border-bottom-style="none" font-size="8pt" font-weight="bold" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="center">
																					<fo:inline>
																	...
																	<fo:table-footer start-indent="0pt">
																		<fo:table-row line-height=".05in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																			<fo:table-cell font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="right"/>
																			</fo:table-cell>
																			<fo:table-cell number-columns-spanned="2" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="right">
																			...
																			<fo:table-cell font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="right">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="TOTAL-WEIGHT">
																								<altova:inline-container-substitute>
																									<xsl:apply-templates/>
																								</altova:inline-container-substitute>
																							</xsl:for-each>
																	...
																	<fo:table-body start-indent="0pt">
																		<xsl:for-each select="$XML">
																			<xsl:for-each select="BOLRM">
																				<xsl:for-each select="LABELS-INFO">
																					<xsl:for-each select="LABEL">
																						<fo:table-row line-height=".05in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																							<fo:table-cell border-bottom-style="none" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="right">
																									<xsl:for-each select="LABEL-ROLL-INFO">
																										<xsl:for-each select="LABEL-ROLL">
																											<xsl:for-each select="ROLL-QTYAMT">
																												<altova:inline-container-substitute>
																													<xsl:apply-templates/>
																												</altova:inline-container-substitute>
																											</xsl:for-each>
																									...
																									<xsl:for-each select="LABEL-WUNITS">
																										<fo:inline>
																											<xsl:text>&#160;</xsl:text>
																										</fo:inline>
																										<altova:inline-container-substitute>
																							...
																							<fo:table-cell number-columns-spanned="2" border-bottom-style="none" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="left">
																									<fo:inline>
																										<xsl:text>&#160;</xsl:text>
																									</fo:inline>
																									<xsl:for-each select="LABEL-STYLE">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell border-bottom-style="none" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="right">
																									<xsl:for-each select="ROLL-LINE-WEIGHT">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																						...
																						<fo:table-row border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".05in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																							<fo:table-cell border-bottom-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="left"/>
																							</fo:table-cell>
																							<fo:table-cell border-bottom-style="none" border-right-style="none" border-top-style="none" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="left">
																									<fo:inline>
																										<xsl:text>&#160;</xsl:text>
																									</fo:inline>
																									<xsl:for-each select="LABEL-COLOR">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="left">
																									<xsl:for-each select="LABEL-PC-FRCLASS">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																						...
																						<fo:table-row line-height=".05in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																							<fo:table-cell border-top-style="none" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="left"/>
																							</fo:table-cell>
																							<fo:table-cell number-columns-spanned="2" border-right-style="none" border-top-style="none" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="before">
																								<fo:block text-align="left">
																									<xsl:variable name="altova:table">
																										<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-bottom="0" padding-left="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																											...
																											<fo:table-column column-width="3.210in"/>
																											...
																											<fo:table-body start-indent="0pt">
																												<xsl:for-each select="LABEL-ROLL-INFO">
																													<xsl:for-each select="LABEL-ROLL">
																														<fo:table-row line-height=".05in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" line-height=".09in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																																<fo:block text-align="left">
																																	<xsl:for-each select="ROLL-ROLLNUM">
																																		<fo:inline>
																							...
																							<fo:table-cell border-right-style="none" border-top-style="none" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="left">
																									<xsl:variable name="altova:table">
																										<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																											...
																											<fo:table-body start-indent="0pt">
																												<xsl:for-each select="LABEL-ROLL-INFO">
																													<xsl:for-each select="LABEL-ROLL">
																														<fo:table-row line-height=".05in">
																															<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" margin-bottom="0" margin-right="0" margin-top="0" padding-bottom="0" padding-right="0" padding-top="0" border="solid 1pt gray" padding="2pt" display-align="center">
																																<fo:block text-align="right">
																																	<fo:inline>
																																		<xsl:text>&#160;&#160;&#160;&#160;&#160; </xsl:text>
																																	</fo:inline>
																																	<xsl:for-each select="ROLL-Q-WEIGHT">
																																		<altova:inline-container-substitute>
																																			<xsl:apply-templates/>
																																		</altova:inline-container-substitute>
																																	</xsl:for-each>
														...
														<xsl:if test="exists( BOLRM/ALT-BOL-INFO/SECTION-BLANK-FORM )">
															<xsl:variable name="altova:table">
																<fo:table margin-bottom="0" margin-right="0" margin-top="0" padding-bottom="0" padding-right="0" padding-top="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																	<fo:table-column column-width="1.040in"/>
																	<fo:table-column column-width="3.500in"/>
																	...
																	<fo:table-body start-indent="0pt">
																		<xsl:for-each select="$XML">
																			<xsl:for-each select="BOLRM">
																				<xsl:for-each select="ALT-BOL-INFO">
																					<xsl:for-each select="SECTION-BLANK-FORM-LINES">
																						<xsl:for-each select="SECTION-BLANK-FORM-LINE">
																							<fo:table-row line-height=".05in" margin-bottom="0" margin-top="0" padding-bottom="0" padding-top="0">
																								<fo:table-cell border-bottom-style="none" font-size="8pt" line-height=".09in" border="solid 1pt gray" padding="2pt" display-align="center">
																									<fo:block text-align="right">
											...
											<fo:table-row border-bottom-color="gray" border-bottom-style="none" border-bottom-width="medium" border-top-color="gray" border-top-style="solid" border-top-width="medium" font-size="10pt" font-weight="bold">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION5">
																		<xsl:for-each select="ALT-BOL-SECTION5-SHIPTERMS">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
											...
											<fo:table-row margin-top="0" padding-top="0">
												<fo:table-cell number-rows-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-rows-spanned="2" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:if test="exists( BOLRM/PRODUCT-INFO-TABLE/NMFC-SUMMARY-H )">
															<xsl:variable name="altova:table">
																<fo:table font-size="6pt" margin-left="0" padding-left="0" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																	<fo:table-column column-width="0.470in"/>
																	<fo:table-column column-width="0.750in"/>
																	<fo:table-column column-width="0.520in"/>
																	<fo:table-column column-width="0.570in"/>
																	<fo:table-column column-width="0.750in"/>
																	<fo:table-column column-width="0.750in"/>
																	<fo:table-column column-width="0.750in"/>
																	...
																	<xsl:variable name="altova:ColumnData"/>
																	<fo:table-header start-indent="0pt">
																		<fo:table-row font-weight="bold" line-height=".09in">
																			<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="center">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-SUMMARY-H">
																									<xsl:for-each select="NMFC-PIECES-H">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																				...
																				<fo:block text-align="center">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-SUMMARY-H">
																									<xsl:for-each select="NMFC-TYPE-H">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																				...
																				<fo:block text-align="center">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-SUMMARY-H">
																									<xsl:for-each select="NMFC-CLASS-H">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																				...
																				<fo:block text-align="center">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-SUMMARY-H">
																									<xsl:for-each select="NMFC-NMFC-H">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																				...
																				<fo:block text-align="center">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-SUMMARY-H">
																									<xsl:for-each select="NMFC-LBS-H">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																			...
																			<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																				<fo:block text-align="center">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-FOOTER">
																									<xsl:for-each select="NMFC-FOOTER-PIECES">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																				...
																				<fo:block text-align="center">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-FOOTER">
																									<xsl:for-each select="NMFC-FOOTER-TYPE">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																				...
																				<fo:block text-align="right">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-FOOTER">
																									<xsl:for-each select="NMFC-FOOTER-SY">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																				...
																				<fo:block text-align="right">
																					<xsl:for-each select="$XML">
																						<xsl:for-each select="BOLRM">
																							<xsl:for-each select="PRODUCT-INFO-TABLE">
																								<xsl:for-each select="NMFC-FOOTER">
																									<xsl:for-each select="NMFC-FOOTER-LBS">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																	...
																	<fo:table-body start-indent="0pt">
																		<xsl:for-each select="$XML">
																			<xsl:for-each select="BOLRM">
																				<xsl:for-each select="PRODUCT-INFO-TABLE">
																					<xsl:for-each select="NMFC-SUMMARY">
																						<fo:table-row line-height=".09in">
																							<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="center">
																									<xsl:for-each select="NMFC-SUMMARY-PIECES">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="center">
																									<xsl:for-each select="NMFC-SUMMARY-TYPE">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="center">
																									<xsl:for-each select="NMFC-SUMMARY-CLASS">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="center">
																									<xsl:for-each select="NMFC-SUMMARY-NMFC">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="right">
																									<xsl:for-each select="NMFC-SUMMARY-SF">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="right">
																									<xsl:for-each select="NMFC-SUMMARY-SY">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
																							...
																							<fo:table-cell margin-bottom="0" padding-bottom="0" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="right">
																									<xsl:for-each select="NMFC-SUMMARY-LBS">
																										<altova:inline-container-substitute>
																											<xsl:apply-templates/>
																										</altova:inline-container-substitute>
																									</xsl:for-each>
															...
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																...
																<fo:table-body start-indent="0pt">
																	<xsl:for-each select="$XML">
																		<xsl:for-each select="BOLRM">
																			<xsl:for-each select="ALT-BOL-INFO">
																				<xsl:for-each select="ALT-BOL-SECTION6">
																					<xsl:for-each select="ALT-BOL-SECTION6-RIGHTBLOCK">
																						<fo:table-row>
																							<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="6pt" border="solid 1pt gray" padding="2pt" display-align="center">
																								<fo:block text-align="left">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
											...
											<fo:table-row margin-top="0" padding-top="0">
												<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="after">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION10">
																		<xsl:for-each select="ALT-BOL-SECTION10-SUBLEVEL">
																			<xsl:for-each select="SECTION10-SUBLEVEL-DEC">
																				<altova:inline-container-substitute font-size="8pt" font-weight="bold">
																					<xsl:apply-templates/>
																				</altova:inline-container-substitute>
																			</xsl:for-each>
																		</xsl:for-each>
											...
											<fo:table-row font-size="10pt">
												...
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="after">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="after">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="3" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="6pt" border="solid 1pt gray" padding="2pt" display-align="after">
													<fo:block text-align="left"/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row border-bottom-color="gray" border-bottom-style="solid" height="0.19in">
												<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="10pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION7">
																		<altova:inline-container-substitute>
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
											...
											<fo:table-row>
												...
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION8">
																		<xsl:for-each select="ALT-BOL-SECTION8-SUBLEVEL">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:for-each select="$XML">
															<xsl:for-each select="BOLRM">
																<xsl:for-each select="ALT-BOL-INFO">
																	<xsl:for-each select="ALT-BOL-SECTION9">
																		<xsl:for-each select="ALT-BOL-SECTION9-SUBLEVEL">
																			<altova:inline-container-substitute>
																				<xsl:apply-templates/>
																			</altova:inline-container-substitute>
																		</xsl:for-each>
														...
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" keep-together.within-page="always" keep-together.within-column="always" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="proportional-column-width(1)"/>
																<fo:table-column column-width="proportional-column-width(1)"/>
																<fo:table-column column-width="proportional-column-width(1)"/>
																<fo:table-column column-width="proportional-column-width(1)"/>
																...
																<fo:table-body start-indent="0pt">
																	<xsl:choose>
																		<xsl:when test="exists( BOLRM/ALT-BOL-INFO/ALT-BOL-SECTION10/ALT-BOL-SECTION10-SUBLEVEL/SECTION10-SUBLEVEL-TOP )">
																			<fo:table-row font-size="9pt">
																				<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left">
																						<fo:inline>
																							<xsl:text>x</xsl:text>
																						</fo:inline>
																				...
																				<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left"/>
																				</fo:table-cell>
																				<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left"/>
																	...
																	<xsl:choose>
																		<xsl:when test="exists( BOLRM/ALT-BOL-INFO/ALT-BOL-SECTION10/ALT-BOL-SECTION10-SUBLEVEL/SECTION10-SUBLEVEL-BOT )">
																			<fo:table-row font-size="9pt">
																				<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="medium" border-left-style="none" border-right-style="none" border-top-style="none" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block text-align="left">
																						<fo:inline>
																						...
																						<xsl:for-each select="$XML">
																							<xsl:for-each select="BOLRM">
																								<xsl:for-each select="ALT-BOL-INFO">
																									<xsl:for-each select="ALT-BOL-SECTION10">
																										<xsl:for-each select="ALT-BOL-SECTION10-SUBLEVEL">
																											<xsl:for-each select="SECTION10-SUBLEVEL-BR">
																												<altova:inline-container-substitute>
																													<xsl:apply-templates/>
																												</altova:inline-container-substitute>
																											</xsl:for-each>
											...
											<fo:table-row>
												...
												<fo:table-cell number-columns-spanned="5" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" border="solid 1pt gray" padding="2pt" display-align="before">
													<fo:block text-align="left">
														<xsl:variable name="altova:table">
															<fo:table border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																<fo:table-column column-width="proportional-column-width(1)"/>
																...
																<fo:table-body start-indent="0pt">
																	<fo:table-row>
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="6pt" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="BOLRM">
																						<xsl:for-each select="ALT-BOL-INFO">
																							<xsl:for-each select="ALT-BOL-SECTION11">
																								<xsl:for-each select="ALT-BOL-SECTION11-DISCLAIMER">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
																		...
																		<fo:table-cell border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="6pt" border="solid 1pt gray" padding="2pt" display-align="before">
																			<fo:block text-align="left">
																				<xsl:for-each select="$XML">
																					<xsl:for-each select="BOLRM">
																						<xsl:for-each select="ALT-BOL-INFO">
																							<xsl:for-each select="ALT-BOL-SECTION12">
																								<xsl:for-each select="ALT-BOL-SECTION12-DISCLAIMER">
																									<altova:inline-container-substitute>
																										<xsl:apply-templates/>
																									</altova:inline-container-substitute>
																								</xsl:for-each>
